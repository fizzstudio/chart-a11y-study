...
export class BarChart {
  ...
  render() {
    ...
    return (h("div", { class: `o-layout is--${this.layout} ${theme}` },
      h("div", { class: "o-layout--chart" },
        ...
        h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'bar', groupName: 'bar group', chartTag: 'bar-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: this.groupAccessor ? true : false, disabled: this.suppressEvents &&
            this.accessibility.elementsAreInterface === false &&
            this.accessibility.keyboardNavConfig &&
            this.accessibility.keyboardNavConfig.disabled }),
  ...
  static get properties() { return {
    ...
    "animationConfig": {
      ...
      "defaultValue": "BarChartDefaultValues.animationConfig"
    },
    "dataLabel": {
      "type": "unknown",
      "mutable": true,
