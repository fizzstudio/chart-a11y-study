...
const ClusteredBarChart$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'clustered-bar-chart-' + v4();
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: `o-layout is--${this.layout} ${theme}` }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "clustered-bar-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions clustered-bar-sub-title vcl-sub-title" }, this.subTitle), h("div", { class: "clustered-bar-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'bar', groupName: 'cluster', chartTag: 'clustered-bar-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation // on bar this requires checking for groupAccessor
      : true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-clustered-bar-container" }), h("div", { class: "clustered-bar-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get clusteredBarChartEl() { return this; }
  ...
  static get style() { return clusteredBarChartCss; }
}, [0, "clustered-bar-chart", {
    ...
    "groupIntervalRatio": [1026, "group-interval-ratio"],
...
function defineCustomElement$1() {
  ...
  const components = ["clustered-bar-chart", "data-table", "keyboard-instructions"];
  components.forEach(tagName => { switch (tagName) {
    case "clustered-bar-chart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ClusteredBarChart$1);
      }
      break;
    case "data-table":
      if (!customElements.get(tagName)) {
...
const ClusteredBarChart = ClusteredBarChart$1;
const defineCustomElement = defineCustomElement$1;

export { ClusteredBarChart, defineCustomElement };
