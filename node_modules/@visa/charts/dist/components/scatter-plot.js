...
import { e as initInterpolator, a as identity, n as nest, l as linear, o as ordinal } from './p-8c5fc147.js';
import { p as powish, s as sqrt } from './p-af2a5112.js';
...
import { i as interpolate } from './p-d8e2f3b3.js';
...
const ScatterPlot$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
      ...
      const baseColor = clicked
        ...
        : hovered
          ...
          : this.groupAccessor && this.sizeConfig.dualEncodeColor
            ? sequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], interpolate('#fff', this.dotColor(d[this.groupAccessor])))(d[this.sizeConfig.sizeAccessor]) || this.dotColor(d[this.groupAccessor])
            : this.groupAccessor && this.sizeConfig && !this.sizeConfig.dualEncodeColor
              ? this.dotColor(d[this.groupAccessor])
              : !this.groupAccessor && this.sizeConfig.dualEncodeColor
                ? sequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], interpolate('#fff', this.rawColors[0]))(d[this.sizeConfig.sizeAccessor]) || this.rawColors[0]
                : this.rawColors[0];
      if (!this.accessibility.hideStrokes) {
  ...
  componentWillLoad() {
    ...
    const chartID = this.uniqueID || 'scatter-plot-' + v4();
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: "o-layout" }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "scatter-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions scatter-sub-title vcl-sub-title" }, this.subTitle), h("div", { class: "scatter-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'scatter group', chartTag: 'scatter-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-scatter-container" }), h("div", { class: "scatter-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
  ...
  get scatterChartEl() { return this; }
  ...
  static get style() { return scatterPlotCss; }
    ...
    "xAccessor": [1025, "x-accessor"],
    "yAccessor": [1025, "y-accessor"],
    "sizeConfig": [1032, "size-config"],
    ...
    "legend": [1040],
    "annotations": [1040],
    "xMaxValueOverride": [2, "x-max-value-override"],
    "xMinValueOverride": [2, "x-min-value-override"],
    "yMaxValueOverride": [2, "y-max-value-override"],
    "yMinValueOverride": [2, "y-min-value-override"],
    "showFitLine": [1028, "show-fit-line"],
    "referenceLines": [1040],
...
function defineCustomElement$1() {
  ...
  const components = ["scatter-plot", "data-table", "keyboard-instructions"];
