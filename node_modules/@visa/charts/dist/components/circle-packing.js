...
const CirclePacking$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  get circlePackingEl() { return this; }
  ...
  static get style() { return circlePackingCss; }
}, [0, "circle-packing", {
    ...
    "margin": [1040],
    "padding": [1040],
    "circlePadding": [1026, "circle-padding"],
    "highestHeadingLevel": [1032, "highest-heading-level"],
    "data": [8],
    "uniqueID": [8, "unique-i-d"],
    "dataDepth": [1026, "data-depth"],
    "displayDepth": [1026, "display-depth"],
    "parentAccessor": [1025, "parent-accessor"],
    "nodeAccessor": [1025, "node-accessor"],
    "sizeAccessor": [1025, "size-accessor"],
...
function defineCustomElement$1() {
  ...
  const components = ["circle-packing", "data-table", "keyboard-instructions"];
  components.forEach(tagName => { switch (tagName) {
    case "circle-packing":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CirclePacking$1);
      }
      break;
    case "data-table":
      if (!customElements.get(tagName)) {
...
const CirclePacking = CirclePacking$1;
const defineCustomElement = defineCustomElement$1;

export { CirclePacking, defineCustomElement };
