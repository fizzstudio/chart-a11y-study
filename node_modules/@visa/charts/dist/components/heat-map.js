...
import { n as nest } from './p-8c5fc147.js';
import { q as quantize } from './p-14552243.js';
...
class HeatMapDefaultValues {
}
HeatMapDefaultValues.mainTitle = 'Heat Map Title';
HeatMapDefaultValues.subTitle = "This is the heat map's subtitle";
HeatMapDefaultValues.height = 250;
HeatMapDefaultValues.width = 500;
HeatMapDefaultValues.margin = {
  top: 250 * 0.01,
  bottom: 250 * 0.01,
  right: 500 * 0.01,
  left: 500 * 0.01
};
HeatMapDefaultValues.padding = {
  top: 20,
  bottom: 30,
  right: 60,
  left: 80
};
HeatMapDefaultValues.xAccessor = 'date';
HeatMapDefaultValues.yAccessor = 'category';
HeatMapDefaultValues.valueAccessor = 'value';
HeatMapDefaultValues.shape = 'rect';
HeatMapDefaultValues.hideAxisPath = propDefaultValues.showBaselineFalse;
HeatMapDefaultValues.accessibility = propDefaultValues.accessibility;
HeatMapDefaultValues.animationConfig = propDefaultValues.animationConfig;
HeatMapDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
HeatMapDefaultValues.xAxis = propDefaultValues.xAxis;
HeatMapDefaultValues.yAxis = propDefaultValues.yAxis;
HeatMapDefaultValues.wrapLabel = propDefaultValues.wrapLabel;
HeatMapDefaultValues.strokeWidth = propDefaultValues.strokeWidth2;
HeatMapDefaultValues.colorPalette = propDefaultValues.colorPaletteSequential;
HeatMapDefaultValues.colorSteps = propDefaultValues.colorSteps5;
HeatMapDefaultValues.hoverStyle = propDefaultValues.hoverStyle;
HeatMapDefaultValues.clickStyle = propDefaultValues.clickStyle;
HeatMapDefaultValues.cursor = propDefaultValues.cursor;
HeatMapDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
HeatMapDefaultValues.dataLabel = propDefaultValues.dataLabel;
HeatMapDefaultValues.legend = propDefaultValues.legend;
HeatMapDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
HeatMapDefaultValues.showTooltip = propDefaultValues.showTooltip;
HeatMapDefaultValues.suppressEvents = propDefaultValues.suppressEvents;
HeatMapDefaultValues.referenceLines = propDefaultValues.referenceLines;
HeatMapDefaultValues.annotations = propDefaultValues.annotations;
HeatMapDefaultValues.clickHighlight = propDefaultValues.clickHighlight;

const heatMapCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}heat-map{cursor:default}heat-map .annotations{pointer-events:none}heat-map .annotations .handle{pointer-events:all}heat-map .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}heat-map .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}heat-map .hidden{display:none}heat-map .axis{font-size:12px}heat-map .axis text{fill:#767676}heat-map .axis-label{text-anchor:middle;font:1rem sans-serif}heat-map .axis path{stroke:#767676}heat-map .axis .hidden{visibility:hidden}heat-map .heat-map-legend{font-size:1em;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}heat-map .heat-map-legend .legend{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}";

const { calculateLuminance, prepareStrokeColorsFromScheme, verifyTextHasSpace, checkAttributeTransitions, createTextStrokeFilter, drawHoverStrokes, removeHoverStrokes, buildStrokes, convertColorsToTextures, findTagLevel, prepareRenderChange, initializeDescriptionRoot, initializeElementAccess, setElementFocusHandler, setElementAccessID, setAccessibilityController, hideNonessentialGroups, setAccessTitle, setAccessSubtitle, setAccessLongDescription, setAccessExecutiveSummary, setAccessPurpose, setAccessContext, setAccessStatistics, setAccessChartCounts, setAccessXAxis, setAccessYAxis, setAccessStructure, setAccessAnnotation, retainAccessFocus, checkAccessFocus, setElementInteractionAccessState, setAccessibilityDescriptionWidth, autoTextColor, annotate, chartAccessors, checkInteraction, checkClicked, checkHovered, convertVisaColor, drawAxis, drawLegend, drawTooltip, formatStats, formatDate, getColors, getLicenses, getPadding, getScopedData, initTooltipStyle, overrideTitleTooltip, placeDataLabels, scopeDataKeys, transitionEndAll, validateAccessibilityProps } = visaChartsUtils_umd;
const HeatMap$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    ...
    this.mainTitle = HeatMapDefaultValues.mainTitle;
    this.subTitle = HeatMapDefaultValues.subTitle;
    this.height = HeatMapDefaultValues.height;
    this.width = HeatMapDefaultValues.width;
    this.highestHeadingLevel = HeatMapDefaultValues.highestHeadingLevel;
    this.margin = HeatMapDefaultValues.margin;
    this.padding = HeatMapDefaultValues.padding;
    this.xAccessor = HeatMapDefaultValues.xAccessor;
    this.yAccessor = HeatMapDefaultValues.yAccessor;
    this.valueAccessor = HeatMapDefaultValues.valueAccessor;
    // Axis (3/7)
    this.xAxis = HeatMapDefaultValues.xAxis;
    this.yAxis = HeatMapDefaultValues.yAxis;
    this.wrapLabel = HeatMapDefaultValues.wrapLabel;
    this.hideAxisPath = HeatMapDefaultValues.hideAxisPath;
    // Color & Shape (4/7)
    this.colorPalette = HeatMapDefaultValues.colorPalette;
    this.colorSteps = HeatMapDefaultValues.colorSteps;
    this.hoverStyle = HeatMapDefaultValues.hoverStyle;
    this.clickStyle = HeatMapDefaultValues.clickStyle;
    this.cursor = HeatMapDefaultValues.cursor;
    this.shape = HeatMapDefaultValues.shape;
    this.hoverOpacity = HeatMapDefaultValues.hoverOpacity;
    this.animationConfig = HeatMapDefaultValues.animationConfig;
    this.strokeWidth = HeatMapDefaultValues.strokeWidth;
    // Data label (5/7)
    this.dataLabel = HeatMapDefaultValues.dataLabel;
    this.showTooltip = HeatMapDefaultValues.showTooltip;
    this.tooltipLabel = HeatMapDefaultValues.tooltipLabel;
    this.accessibility = HeatMapDefaultValues.accessibility;
    this.legend = HeatMapDefaultValues.legend;
    this.annotations = HeatMapDefaultValues.annotations;
    this.clickHighlight = HeatMapDefaultValues.clickHighlight;
    this.suppressEvents = HeatMapDefaultValues.suppressEvents;
    // Testing (8/7)
    this.unitTest = false;
    ...
    this.textTreatmentHandler = (d, i, n) => {
      const bgColor = !this.accessibility.hideTextures && this.accessibility.showExperimentalTextures
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'heat-map-' + v4();
  ...
  prepareScales() {
    const minMapValue = (this.minValueOverride || this.minValueOverride === 0) &&
      this.minValueOverride < min(this.preppedData, d => d.valueAccessor)
      ? this.minValueOverride
      : min(this.preppedData, d => d.valueAccessor);
    const maxMapValue = (this.maxValueOverride || this.maxValueOverride === 0) &&
    ...
    this.heat = quantize().domain([minMapValue, maxMapValue]);
    const strokeColors = [];
    ...
    this.preparedColors.forEach(color => {
      const colorsMatchingScheme = prepareStrokeColorsFromScheme(color, i, this.preparedColors, isDiverging ? 'diverging' : 'sequential');
      if (isDiverging) {
    ...
    this.fillColors = quantize()
      .domain([minMapValue, maxMapValue])
      .range(backgroundColors);
    this.strokeColors = quantize()
      .domain([minMapValue, maxMapValue])
      .range(strokeColors);
    this.rawHeat = quantize()
      .domain([minMapValue, maxMapValue])
  ...
  setStrokes() {
    ...
    const clickStyle = Object.assign(Object.assign({}, this.clickStyle), { color: undefined });
    const hoverStyle = Object.assign(Object.assign({}, this.hoverStyle), { color: undefined });
    this.strokes = buildStrokes({
      root: this.svg.node(),
      id: this.chartID,
      colors: !this.accessibility.hideTextures && this.accessibility.showExperimentalTextures
        ? this.fillColors.range()
        : this.preparedColors,
      clickStyle,
      hoverStyle,
      strokeOverride: !this.accessibility.hideTextures && this.accessibility.showExperimentalTextures
  ...
  updateGeometries() {
    ...
    this.update
      ...
      .ease(circleIn)
      .attr('opacity', d => {
      return checkInteraction(d, 1, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
    });
  }
  exitGeometries() {
    this.exit.interrupt();
  ...
  updateInteractionState() {
    ...
    this.update
      ...
      if (!this.accessibility.hideStrokes && !select(n[i]).classed('geometryIsMoving')) {
        ...
        const baseColor = !this.accessibility.hideTextures && this.accessibility.showExperimentalTextures
          ? this.fillColors(d[this.valueAccessor])
          : this.rawHeat(d[this.valueAccessor]);
        const strokeOverride = !this.accessibility.hideTextures && this.accessibility.showExperimentalTextures
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: `o-layout` }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "heat-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions heat-sub-title vcl-sub-title" }, this.subTitle), h("div", { class: "heat-map-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'cell', groupName: 'row', chartTag: 'heat-map', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-heat-map-container" }), h("div", { class: "heat-map-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  static get watchers() { return {
    ...
    "valueAccessor": ["groupAccessorWatcher"],
    "xKeyOrder": ["xKeyOrderWatcher"],
    "yKeyOrder": ["yKeyOrderWatcher"],
    "xAxis": ["xAxisWatcher"],
    "yAxis": ["yAxisWatcher"],
    "wrapLabel": ["wrapLabelWatcher"],
    "hideAxisPath": ["hideAxisPathWatcher"],
    "colorPalette": ["colorsWatcher"],
    "colors": ["colorsWatcher"],
    "colorSteps": ["colorsWatcher"],
  ...
  static get style() { return heatMapCss; }
    ...
    "hideAxisPath": [1028, "hide-axis-path"],
    "colorPalette": [1025, "color-palette"],
    "colors": [1040],
    "colorSteps": [1026, "color-steps"],
    "hoverStyle": [1040],
    "clickStyle": [1040],
    "cursor": [1025],
    "shape": [1025],
...
function defineCustomElement$1() {
  ...
  const components = ["heat-map", "data-table", "keyboard-instructions"];
  components.forEach(tagName => { switch (tagName) {
    case "heat-map":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HeatMap$1);
      }
      break;
    case "data-table":
      if (!customElements.get(tagName)) {
