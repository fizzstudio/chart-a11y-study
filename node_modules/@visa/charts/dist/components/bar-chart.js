...
import { n as nest, o as ordinal, l as linear } from './p-8c5fc147.js';
...
const BarChart$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  prepareScales() {
    ...
    const minBarValue = this.minValueOverride && this.minValueOverride < min(this.preppedData, d => d[this.valueAccessor])
      ? this.minValueOverride
      : min(this.preppedData, d => d[this.valueAccessor]);
    const maxBarValue = this.maxValueOverride && this.maxValueOverride > max(this.preppedData, d => d[this.valueAccessor])
  ...
  static get style() { return barChartCss; }
}, [0, "bar-chart", {
...
function defineCustomElement$1() {
  ...
  const components = ["bar-chart", "data-table", "keyboard-instructions"];
  components.forEach(tagName => { switch (tagName) {
    case "bar-chart":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, BarChart$1);
      }
      break;
    case "data-table":
      if (!customElements.get(tagName)) {
...
const BarChart = BarChart$1;
const defineCustomElement = defineCustomElement$1;

export { BarChart, defineCustomElement };
