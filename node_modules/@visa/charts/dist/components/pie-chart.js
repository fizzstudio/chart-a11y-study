...
const PieChart$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'pie-chart-' + v4();
  ...
  drawGeometries() {
    this.update
      ...
      .transition('update')
      .duration(this.duration)
      .ease(circleIn)[this.duration ? 'attrTween' : 'attr']('d', (d, i, n) => {
      const me = n[i];
  ...
  drawDataLabels(group) {
    ...
    this['updating' + group]
      ...
      .transition('update')
      .duration(this.duration)
      .ease(circleIn)[this.duration ? 'attrTween' : 'attr']('x', (d, i, n) => {
      const me = n[i];
      let start = me._current;
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: "o-layout is--vertical" }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "pie-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions pie-sub-title vcl-sub-title" }, this.subTitle), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'slice', groupName: 'pie', chartTag: 'pie-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: false, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-pie-container" }), h("div", { class: "pie-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
  ...
  static get style() { return pieChartCss; }
    ...
    "centerTitle": [1025, "center-title"],
    "centerSubTitle": [1025, "center-sub-title"],
    "height": [1026],
    "width": [1026],
    ...
    "colors": [1040],
    "innerRatio": [1026, "inner-ratio"],
    "showEdgeLine": [1028, "show-edge-line"],
    "hoverStyle": [1040],
    "clickStyle": [1040],
    "referenceStyle": [1040],
    "cursor": [1025],
    ...
    "showPercentage": [1028, "show-percentage"],
    "showTooltip": [1028, "show-tooltip"],
    "showLabelNote": [1028, "show-label-note"],
    "labelOffset": [1026, "label-offset"],
    "dataLabel": [1040],
    "tooltipLabel": [1040],
    "accessibility": [1040],
    "annotations": [1040],
...
function defineCustomElement$1() {
  ...
  const components = ["pie-chart", "data-table", "keyboard-instructions"];
