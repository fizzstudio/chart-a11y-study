...
import { l as line } from './p-033e8797.js';
...
const ParallelPlot$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  get parallelChartEl() { return this; }
  ...
  static get style() { return parallelPlotCss; }
}, [0, "parallel-plot", {
    ...
    "strokeWidth": [1026, "stroke-width"],
    "showDots": [1028, "show-dots"],
    "dotRadius": [1026, "dot-radius"],
    "dataLabel": [1040],
    ...
    "annotations": [1040],
    "seriesLabel": [1040],
    "maxValueOverride": [2, "max-value-override"],
    "minValueOverride": [2, "min-value-override"],
    "referenceLines": [1040],
    "secondaryLines": [1040],
...
function defineCustomElement$1() {
  ...
  const components = ["parallel-plot", "data-table", "keyboard-instructions"];
  components.forEach(tagName => { switch (tagName) {
    case "parallel-plot":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ParallelPlot$1);
      }
      break;
    case "data-table":
      if (!customElements.get(tagName)) {
...
const ParallelPlot = ParallelPlot$1;
const defineCustomElement = defineCustomElement$1;

export { ParallelPlot, defineCustomElement };
