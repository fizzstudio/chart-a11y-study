...
const { getLicenses: getLicenses$1 } = visaChartsUtils_umd.visaChartsUtils_umd;
const DataTable = class {
  ...
  reSetRoot() {
    ...
    visaChartsUtils_umd.select(this.dataTableEl)
    ...
    if (!this.table && this.showTable) {
      this.defaults = true;
      this.table = visaChartsUtils_umd.select(this.dataTableEl)
      ...
      if (this.secondaryData) {
        ...
        this.secondaryTable = visaChartsUtils_umd.select(this.dataTableEl)
          .select('#visa-viz-data-table-container-' + this.uniqueID)
          .append('table')
  ...
  render() {
    ...
    return (index.h("div", { class: "visa-viz-data-table-outer-container", "data-testid": this.unitTest ? 'data-table-outer-container' : null }, index.h("div", { class: "visa-viz-button-wrapper", style: {
      ...
      } }, index.h("button", { id: `visa-viz-data-table-button-${this.uniqueID}`, type: "button", class: "vcc-btn-icon vcc-btn-icon--light-tiny visa-viz-data-table-button", style: {
      ...
      }, "aria-label": "display data table", "aria-expanded": this.showTable ? 'true' : 'false', role: "button", tabIndex: 0, onClick: () => (this.showTable = !this.showTable) }, index.h("svg", Object.assign({ class: "vcc-icon--tiny", focusable: "false" }, svgProps), index.h("use", Object.assign({}, useProps)))), index.h("svg", { class: "vcc-icons" }, index.h("symbol", Object.assign({ id: `visa-viz-view-grid--tiny-${this.uniqueID}` }, symbolProps), index.h("path", { d: "M5,5 L5,2 L2,2 L2,5 L5,5 Z M5,7 L2,7 C0.894905844,7 0,6.1044757 0,5 L0,2 C0,0.8955243 0.894905844,3.55271368e-15 2,3.55271368e-15 L5,3.55271368e-15 C6.10509416,3.55271368e-15 7,0.8955243 7,2 L7,5 C7,6.1044757 6.10509416,7 5,7 Z M14,5 L14,2 L11,2 L11,5 L14,5 Z M14,7 L11,7 C9.89490584,7 9,6.1044757 9,5 L9,2 C9,0.8955243 9.89490584,3.55271368e-15 11,3.55271368e-15 L14,3.55271368e-15 C15.1050942,3.55271368e-15 16,0.8955243 16,2 L16,5 C16,6.1044757 15.1050942,7 14,7 Z M5,14 L5,11 L2,11 L2,14 L5,14 Z M5,16 L2,16 C0.894905844,16 0,15.1044757 0,14 L0,11 C0,9.8955243 0.894905844,9 2,9 L5,9 C6.10509416,9 7,9.8955243 7,11 L7,14 C7,15.1044757 6.10509416,16 5,16 Z M14,14 L14,11 L11,11 L11,14 L14,14 Z M14,16 L11,16 C9.89490584,16 9,15.1044757 9,14 L9,11 C9,9.8955243 9.89490584,9 11,9 L14,9 C15.1050942,9 16,9.8955243 16,11 L16,14 C16,15.1044757 15.1050942,16 14,16 Z" }), index.h("g", { fill: "none", "fill-rule": "evenodd", stroke: "none", "stroke-width": "1" }, index.h("mask", { fill: "#fff" }, index.h("use", { xlinkHref: "#path-1" })), index.h("use", { fill: "#000", "fill-rule": "nonzero", xlinkHref: "#path-1" }))))), index.h("div", { id: `visa-viz-data-table-container-${this.uniqueID}`, class: "visa-viz-data-table-container", "data-testid": this.unitTest ? 'data-table-container' : null })));
  }
  init() {
    // reading properties
  ...
  get dataTableEl() { return index.getElement(this); }
};
// incorporate OSS licenses into build
window['VisaChartsLibOSSLicenses'] = getLicenses$1(); // tslint:disable-line no-string-literal
...
const KeyboardInstructions = class {
  constructor(hostRef) {
    ...
    this.instructionsMenu = () => {
      if (this.showInstructions) {
        return (index.h("div", null, index.h("p", null, "Note: for VoiceOver users (mac), press and hold ", index.h("kbd", null, "Ctrl"), " + ", index.h("kbd", null, "Shift"), " when using the arrow keys for the best navigation experience."), index.h("table", { class: "vcc-ki-keyboard-instructions vcc-ki-data-table vcc-ki-state--single-select vcc-ki-state--compact", "data-header": "header" }, index.h("thead", { class: "vcc-ki-thead" }, index.h("tr", { class: "vcc-ki-tr" }, index.h("th", { class: "vcc-ki-th", scope: "col" }, "Action"), index.h("th", { class: "vcc-ki-th", scope: "col" }, "Result"))), index.h("tbody", { class: "vcc-ki-tbody" }, index.h("tr", { class: "vcc-ki-tr" }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "Enter"), " on the chart area or a ", this.groupName, "."), index.h("td", { class: "vcc-ki-td" }, "Enter the chart area/drill down a level.")), index.h("tr", { class: "vcc-ki-tr" }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "Esc"), " on a ", this.groupName, " or ", this.geomType, "."), index.h("td", { class: "vcc-ki-td" }, "Drill up a level.")), index.h("tr", { class: "vcc-ki-tr" }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "Tab"), " at any time."), index.h("td", { class: "vcc-ki-td" }, "Exit the chart.")), index.h("tr", { class: this.isInteractive ? 'vcc-ki-tr' : 'vcc-ki-tr vcc-ki-disabled-row' }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "Space"), " ", this.isInteractive ? 'on a ' + this.geomType : 'is unused', "."), index.h("td", { class: "vcc-ki-td" }, this.isInteractive ? 'Select/Deselect a ' + this.geomType : 'No effect on this chart', ".")), index.h("tr", { class: "vcc-ki-tr" }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "\u2190"), " / ", index.h("kbd", null, "\u2192"), " on a ", this.groupName, " or ", this.geomType, "."), index.h("td", { class: "vcc-ki-td" }, "Move among sibling ", this.groupName, "s or ", this.geomType, "s.")), index.h("tr", { class: this.hasCousinNavigation ? 'vcc-ki-tr' : 'vcc-ki-tr vcc-ki-disabled-row' }, index.h("th", { scope: "row", class: "vcc-ki-td" }, index.h("kbd", null, "\u2191"), " / ", index.h("kbd", null, "\u2193"), " ", this.cousinAction(), "."), index.h("td", { class: "vcc-ki-td" }, this.cousinResult(), "."))))));
      }
    };
  }
  ...
  render() {
    ...
    const symbolProps = { viewbox: '0 0 16 16' };
    return (index.h("div", { class: "vcc-ki-keyboard-instructions-root", style: { position: 'relative', width: `${this.width}px` } }, index.h("div", { class: this.showHeading || this.showInstructions
        ? 'visa-viz-keyboard-instructions-outer-container vcc-ki-bordered'
        : 'visa-viz-keyboard-instructions-outer-container', "data-testid": this.unitTest ? 'keyboard-instructions-outer-container' : null, style: { width: `${this.innerWidth - 34}px` } }, index.h("div", { class: this.showHeading || this.showInstructions
        ? 'vcc-ki-keyboard-instructions-header'
        : 'vcc-ki-keyboard-instructions-header vcc-ki-minimize' }, index.h("p", { class: "vcc-ki-keyboard-heading" }, this.showInstructions ? 'Keyboard Instructions' : 'Display Keyboard Instructions')), index.h("div", { class: "visa-viz-keyboard-instructions-button-wrapper" }, index.h("button", { id: `visa-viz-keyboard-instructions-button-${this.uniqueID}`, type: "button", class: "vcc-ki-btn-icon vcc-ki-btn-icon--light-tiny visa-viz-keyboard-instructions-button", "aria-label": this.showInstructions ? 'close keyboard instructions' : 'display keyboard instructions', "aria-expanded": this.showInstructions ? 'true' : 'false', role: "button", tabIndex: 0, onClick: () => {
        this.showInstructions = !this.showInstructions;
        this.showHeading = false;
      }, onFocus: () => (this.showHeading = true), onBlur: () => (this.showHeading = this.showInstructions) }, index.h("svg", Object.assign({ class: "vcc-ki-icon--tiny", focusable: "false" }, svgProps), index.h("use", Object.assign({}, useProps)))), index.h("svg", { class: "vcc-ki-icons" }, index.h("symbol", Object.assign({ id: `visa-viz-keyboard-instructions-info--tiny-${this.uniqueID}` }, symbolProps), this.showInstructions ? (index.h("path", { d: "M9.41,8l5.3,5.29a1,1,0,0,1-1.42,1.42L8,9.41l-5.29,5.3a1,1,0,0,1-1.42-1.42L6.59,8,1.29,2.71A1,1,0,0,1,2.71,1.29L8,6.59l5.29-5.3a1,1,0,1,1,1.42,1.42Z" })) : (index.h("path", { d: "M8.7,3.8a.68.68,0,0,1,.7.7.79.79,0,0,1-.8.8H8.5c-.4,0-.6-.3-.6-.7A.79.79,0,0,1,8.7,3.8ZM6.6,12.1l1.2-6H9l-1.2,6ZM14,8a6,6,0,1,0-6,6A6,6,0,0,0,14,8Zm2,0A8,8,0,1,1,8,0,8,8,0,0,1,16,8Z" }))))), index.h("div", { id: `visa-viz-keyboard-instructions-container-${this.uniqueID}`, class: "visa-viz-keyboard-instructions-container", "data-testid": this.unitTest ? 'keyboard-instructions-container' : null }, this.instructionsMenu()))));
  }
  init() {
    // reading properties
  ...
  get keyboardInstructionsEl() { return index.getElement(this); }
...
KeyboardInstructions.style = keyboardInstructionsCss;

exports.data_table = DataTable;
exports.keyboard_instructions = KeyboardInstructions;
