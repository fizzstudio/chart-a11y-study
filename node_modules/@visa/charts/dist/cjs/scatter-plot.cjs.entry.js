...
function sequentialPow() {
  ...
  return linear.initInterpolator.apply(scale, arguments);
}
...
class ScatterPlotDefaultValues {
}
ScatterPlotDefaultValues.mainTitle = 'Scatter Plot Title';
ScatterPlotDefaultValues.subTitle = "This is the scatter plot's subtitle";
ScatterPlotDefaultValues.height = 300;
ScatterPlotDefaultValues.width = 650;
ScatterPlotDefaultValues.margin = {
  top: 300 * 0.01,
  bottom: 300 * 0.01,
  right: 650 * 0.01,
  left: 650 * 0.01
};
ScatterPlotDefaultValues.padding = {
  top: 20,
  bottom: 50,
  right: 50,
  left: 60
};
ScatterPlotDefaultValues.xAccessor = 'metric';
ScatterPlotDefaultValues.yAccessor = 'value';
ScatterPlotDefaultValues.groupAccessor = 'category';
ScatterPlotDefaultValues.sizeConfig = propDefaultValues.sizeConfig;
ScatterPlotDefaultValues.accessibility = propDefaultValues.accessibility;
ScatterPlotDefaultValues.animationConfig = propDefaultValues.animationConfig;
ScatterPlotDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
ScatterPlotDefaultValues.sortOrder = propDefaultValues.sortOrder;
ScatterPlotDefaultValues.xAxis = propDefaultValues.xAxis;
ScatterPlotDefaultValues.yAxis = propDefaultValues.yAxis;
ScatterPlotDefaultValues.showBaselineX = propDefaultValues.showBaselineTrue;
ScatterPlotDefaultValues.showBaselineY = propDefaultValues.showBaselineFalse;
ScatterPlotDefaultValues.colorPalette = propDefaultValues.colorPaletteCategorical;
ScatterPlotDefaultValues.dotRadius = propDefaultValues.dotRadius6;
ScatterPlotDefaultValues.dotOpacity = propDefaultValues.dotOpacity;
ScatterPlotDefaultValues.dotSymbols = propDefaultValues.dotSymbols;
ScatterPlotDefaultValues.referenceStyle = propDefaultValues.referenceStyle;
ScatterPlotDefaultValues.showFitLine = propDefaultValues.showFitLine;
ScatterPlotDefaultValues.fitLineStyle = propDefaultValues.referenceStyle;
ScatterPlotDefaultValues.cursor = propDefaultValues.cursor;
ScatterPlotDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
ScatterPlotDefaultValues.hoverStyle = propDefaultValues.symbolHoverStyle;
ScatterPlotDefaultValues.clickStyle = propDefaultValues.symbolClickStyle;
ScatterPlotDefaultValues.dataLabel = propDefaultValues.dataLabel;
ScatterPlotDefaultValues.legend = propDefaultValues.categoryLegend;
ScatterPlotDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
ScatterPlotDefaultValues.showTooltip = propDefaultValues.showTooltip;
ScatterPlotDefaultValues.suppressEvents = propDefaultValues.suppressEvents;
ScatterPlotDefaultValues.referenceLines = propDefaultValues.referenceLines;
ScatterPlotDefaultValues.annotations = propDefaultValues.annotations;
ScatterPlotDefaultValues.clickHighlight = propDefaultValues.clickHighlight;

const scatterPlotCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}scatter-plot .annotations{pointer-events:none}scatter-plot .annotations .handle{pointer-events:all}scatter-plot .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}scatter-plot .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}scatter-plot .hidden{display:none}scatter-plot .axis{font-size:12px}scatter-plot .axis text{font:0.65rem;fill:#767676}scatter-plot .axis-label{text-anchor:middle;font:1rem sans-serif}scatter-plot .axis path{stroke:#767676}scatter-plot .axis-mark path{stroke:#767676;stroke-opacity:1}scatter-plot .grid line{stroke:#767676;stroke-opacity:0.6;shape-rendering:crispEdges;stroke-dasharray:4, 4}scatter-plot .grid path{stroke-width:0;stroke:#767676}scatter-plot .scatter-legend{font-size:1em;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}scatter-plot .scatter-legend .legend{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}";

const { getAccessibleStrokes, ensureTextContrast, createTextStrokeFilter, initializeDescriptionRoot, initializeElementAccess, setElementFocusHandler, setElementAccessID, setAccessibilityController, hideNonessentialGroups, setAccessTitle, setAccessSubtitle, setAccessLongDescription, setAccessExecutiveSummary, setAccessPurpose, setAccessContext, setAccessStatistics, setAccessChartCounts, setAccessXAxis, setAccessYAxis, setAccessStructure, setAccessAnnotation, retainAccessFocus, checkAccessFocus, setElementInteractionAccessState, setAccessibilityDescriptionWidth, annotate, chartAccessors, checkInteraction, checkClicked, checkHovered, convertVisaColor, drawAxis, drawGrid, drawLegend, setLegendInteractionState, drawTooltip, formatDataLabel, getColors, getLicenses, getPadding, getScopedData, initTooltipStyle, leastSquares, overrideTitleTooltip, placeDataLabels, scopeDataKeys, symbols, transitionEndAll, visaColors, validateAccessibilityProps, findTagLevel, prepareRenderChange, roundTo, resolveLabelCollision } = visaChartsUtils_umd.visaChartsUtils_umd;
const ScatterPlot = class {
  constructor(hostRef) {
    ...
    this.mainTitle = ScatterPlotDefaultValues.mainTitle;
    this.subTitle = ScatterPlotDefaultValues.subTitle;
    this.height = ScatterPlotDefaultValues.height;
    this.width = ScatterPlotDefaultValues.width;
    this.margin = ScatterPlotDefaultValues.margin;
    this.padding = ScatterPlotDefaultValues.padding;
    this.highestHeadingLevel = ScatterPlotDefaultValues.highestHeadingLevel;
    this.xAccessor = ScatterPlotDefaultValues.xAccessor;
    this.yAccessor = ScatterPlotDefaultValues.yAccessor;
    this.sizeConfig = ScatterPlotDefaultValues.sizeConfig;
    this.groupAccessor = ScatterPlotDefaultValues.groupAccessor;
    // Axis (3/7)
    this.xAxis = ScatterPlotDefaultValues.xAxis;
    this.yAxis = ScatterPlotDefaultValues.yAxis;
    this.showBaselineX = ScatterPlotDefaultValues.showBaselineX;
    this.showBaselineY = ScatterPlotDefaultValues.showBaselineY;
    // Color & Shape (4/7)
    this.colorPalette = ScatterPlotDefaultValues.colorPalette;
    this.dotRadius = ScatterPlotDefaultValues.dotRadius;
    this.dotOpacity = ScatterPlotDefaultValues.dotOpacity;
    this.hoverStyle = ScatterPlotDefaultValues.hoverStyle;
    this.clickStyle = ScatterPlotDefaultValues.clickStyle;
    this.referenceStyle = ScatterPlotDefaultValues.referenceStyle;
    this.cursor = ScatterPlotDefaultValues.cursor;
    this.hoverOpacity = ScatterPlotDefaultValues.hoverOpacity;
    this.animationConfig = ScatterPlotDefaultValues.animationConfig;
    this.fitLineStyle = ScatterPlotDefaultValues.fitLineStyle;
    this.dotSymbols = ScatterPlotDefaultValues.dotSymbols;
    // Data label (5/7)
    this.dataLabel = ScatterPlotDefaultValues.dataLabel;
    this.showTooltip = ScatterPlotDefaultValues.showTooltip;
    this.tooltipLabel = ScatterPlotDefaultValues.tooltipLabel;
    this.accessibility = ScatterPlotDefaultValues.accessibility;
    this.legend = ScatterPlotDefaultValues.legend;
    this.annotations = ScatterPlotDefaultValues.annotations;
    this.showFitLine = ScatterPlotDefaultValues.showFitLine;
    this.referenceLines = ScatterPlotDefaultValues.referenceLines;
    // Interactivity (7/7)
    this.suppressEvents = ScatterPlotDefaultValues.suppressEvents;
    this.clickHighlight = ScatterPlotDefaultValues.clickHighlight;
    // Testing (8/7)
    this.unitTest = false;
      ...
      const baseColor = clicked
        ...
        : hovered
          ...
          : this.groupAccessor && this.sizeConfig.dualEncodeColor
            ? sequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], value.interpolate('#fff', this.dotColor(d[this.groupAccessor])))(d[this.sizeConfig.sizeAccessor]) || this.dotColor(d[this.groupAccessor])
            : this.groupAccessor && this.sizeConfig && !this.sizeConfig.dualEncodeColor
              ? this.dotColor(d[this.groupAccessor])
              : !this.groupAccessor && this.sizeConfig.dualEncodeColor
                ? sequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], value.interpolate('#fff', this.rawColors[0]))(d[this.sizeConfig.sizeAccessor]) || this.rawColors[0]
                : this.rawColors[0];
      if (!this.accessibility.hideStrokes) {
        const strokeWidth = (clicked
          ? parseFloat(this.innerClickStyle.strokeWidth) || 1
          : hovered
            ? parseFloat(this.innerHoverStyle.strokeWidth) || 1
            : 1) /
          (this.size(d[this.sizeConfig.sizeAccessor] * this.shapeArea[this.groupAccessor ? d[this.groupAccessor] : '']['toCircle']) ||
            this.dotRadius ||
            1);
        visaChartsUtils_umd.select(n[i]).attr('stroke-width', strokeWidth);
  ...
  componentWillLoad() {
    ...
    const chartID = this.uniqueID || 'scatter-plot-' + index$1.v4();
  ...
  prepareScales() {
    const xMinValue = min.min(this.data, d => parseFloat(d[this.xAccessor]));
    const xMaxValue = max.max(this.data, d => parseFloat(d[this.xAccessor]));
    const yMinValue = min.min(this.data, d => parseFloat(d[this.yAccessor]));
    const yMaxValue = max.max(this.data, d => parseFloat(d[this.yAccessor]));
    const zMinValue = min.min(this.data, d => parseFloat(d[this.sizeConfig.sizeAccessor]));
    const zMaxValue = max.max(this.data, d => parseFloat(d[this.sizeConfig.sizeAccessor]));
  ...
  addStrokeUnder() {
    ...
    this.updatePoints.attr('filter', (_, i, n) => (!visaChartsUtils_umd.select(n[i]).classed('moving') ? this.filter : null));
  }
  updateStrokeWidth() {
    this.updatePoints.attr('stroke', this.handleDotStyle);
  }
  renderRootElements() {
    this.svg = visaChartsUtils_umd.select(this.scatterChartEl)
    ...
    this.legendG = visaChartsUtils_umd.select(this.scatterChartEl)
      .select('.scatter-legend')
      .append('svg');
    this.tooltipG = visaChartsUtils_umd.select(this.scatterChartEl).select('.scatter-tooltip');
  ...
  setTestingAttributes() {
    if (this.unitTest) {
      visaChartsUtils_umd.select(this.scatterChartEl)
        .select('.visa-viz-d3-scatter-container')
  ...
  enterPointGroups() {
    ...
    this.enterPointWrappers
      ...
      .on('mouseover', this.groupInteraction && !this.suppressEvents
    ...
    this.enterPoints
      ...
      .attr('d', d => this.groupAccessor ? symbols[this.symbol(d[this.groupAccessor])].general : symbols[this.dotSymbols[0]].general)
      .attr('transform', d => 'translate(' + this.x(d[this.xAccessor]) + ',' + this.y(d[this.yAccessor]) + ') scale(1)');
  ...
  exitPointGroups() {
    ...
    this.exitPointWrappers
      ...
      const transform = visaChartsUtils_umd.select(n[i]).attr('transform');
  ...
  drawPointGroups() {
    this.updatePoints
      ...
      const rChange = +me.attr('data-r') !==
        this.size(d[this.sizeConfig.sizeAccessor] *
      ...
      .attr('data-r', d => {
      return (this.size(d[this.sizeConfig.sizeAccessor] *
        this.shapeArea[this.groupAccessor ? d[this.groupAccessor] : '']['toCircle']) ||
        this.dotRadius ||
        1);
    })
      ...
      .attr('data-d', (d // we can use base symbol here, it is much simplier and more performant
  ...
  bindLegendInteractivity() {
    visaChartsUtils_umd.select(this.scatterChartEl)
      .selectAll('.legend')
      .on('click', this.legend.interactive && !this.suppressEvents
  ...
  enterDataLabels() {
    ...
    this.enterLabels
      .attr('filter', this.textFilter)
      .attr('opacity', d => {
      return checkInteraction(d, opacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
        ? 0
      ...
      .on('mouseover', !this.suppressEvents && this.dataLabel.visible ? (d, i, n) => this.onHoverHandler(d, n[i]) : null)
  ...
  updateDataLabels() {
    ...
    this.updateLabels
      ...
      visaChartsUtils_umd.select(n[i]).classed('entering', false);
    });
  }
  exitDataLabels() {
  ...
  drawDataLabels() {
    ...
    this.bitmaps = placeDataLabels({
      ...
      avoidCollision: {
        ...
        accessors: [this.xAccessor, this.yAccessor, this.groupAccessor, 'key'],
  ...
  setPointOpacity() {
    ...
    this.updatePoints
      ...
      .ease(circle.circleIn)
      .attr('opacity', d => checkInteraction(d, this.dotOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys))
      .call(transitionEndAll, (_, i, n) => {
      visaChartsUtils_umd.select(n[i]).classed('entering', false);
    });
  }
  setLabelOpacity() {
    ...
    this.updateLabels
      ...
      const targetOpacity = checkInteraction(d, this.dataLabel.visible ? 1 : 0, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
        ? 0
        : 1;
    ...
    if (addCollisionClass) {
      const labelsAdded = this.updateLabels.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-added'));
      const labelsRemoved = this.updateLabels.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-removed')); // .transition().duration(0);
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: "o-layout" }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { class: "scatter-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions scatter-sub-title vcl-sub-title" }, this.subTitle), index.h("div", { class: "scatter-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'scatter group', chartTag: 'scatter-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-scatter-container" }), index.h("div", { class: "scatter-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
  ...
  get scatterChartEl() { return index.getElement(this); }
  static get watchers() { return {
    ...
    "height": ["layoutWatcher"],
    "width": ["layoutWatcher"],
    "padding": ["layoutWatcher"],
    "margin": ["layoutWatcher"],
    "xAccessor": ["xAccessorWatcher"],
    "yAccessor": ["yAccessorWatcher"],
    "sizeConfig": ["sizeConfigWatcher"],
    ...
    "xMaxValueOverride": ["xValueOverrideWatcher"],
    "xMinValueOverride": ["xValueOverrideWatcher"],
    "yMaxValueOverride": ["yValueOverrideWatcher"],
    "yMinValueOverride": ["yValueOverrideWatcher"],
    "showFitLine": ["showFitLineWatcher"],
