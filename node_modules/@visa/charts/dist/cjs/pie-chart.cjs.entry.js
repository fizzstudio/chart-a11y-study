...
const constant = require('./constant-7c4eeb3b.js');
...
function arc() {
  var innerRadius = arcInnerRadius,
      ...
      cornerRadius = constant.constant(0),
      padRadius = null,
  ...
  function arc() {
    ...
    if (!context) context = buffer = constant.path();
  ...
  arc.innerRadius = function(_) {
    return arguments.length ? (innerRadius = typeof _ === "function" ? _ : constant.constant(+_), arc) : innerRadius;
  };

  arc.outerRadius = function(_) {
    return arguments.length ? (outerRadius = typeof _ === "function" ? _ : constant.constant(+_), arc) : outerRadius;
  };

  arc.cornerRadius = function(_) {
    return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : constant.constant(+_), arc) : cornerRadius;
  };

  arc.padRadius = function(_) {
    return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : constant.constant(+_), arc) : padRadius;
  };

  arc.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant.constant(+_), arc) : startAngle;
  };

  arc.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant.constant(+_), arc) : endAngle;
  };

  arc.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant.constant(+_), arc) : padAngle;
  };
...
function pie() {
  var value = identity,
      ...
      sort = null,
      startAngle = constant.constant(0),
      endAngle = constant.constant(tau),
      padAngle = constant.constant(0);
  ...
  pie.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant.constant(+_), pie) : value;
  };
  ...
  pie.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant.constant(+_), pie) : startAngle;
  };

  pie.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant.constant(+_), pie) : endAngle;
  };

  pie.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant.constant(+_), pie) : padAngle;
  };
...
class PieChartDefaultValues {
}
PieChartDefaultValues.mainTitle = 'Pie Chart Title';
PieChartDefaultValues.subTitle = "This is the pie chart's subtitle";
PieChartDefaultValues.centerTitle = '';
PieChartDefaultValues.centerSubTitle = '';
PieChartDefaultValues.height = 325;
PieChartDefaultValues.width = 600;
PieChartDefaultValues.margin = {
  top: 600 * 0.05,
  bottom: 600 * 0.05,
  right: 600 * 0.05,
  left: 600 * 0.05
};
PieChartDefaultValues.padding = {
  top: 20,
  bottom: 50,
  right: 70,
  left: 70
};
PieChartDefaultValues.ordinalAccessor = 'label';
PieChartDefaultValues.valueAccessor = 'value';
PieChartDefaultValues.innerRatio = 0.7;
PieChartDefaultValues.showEdgeLine = false;
PieChartDefaultValues.showPercentage = true;
PieChartDefaultValues.showLabelNote = true;
PieChartDefaultValues.labelOffset = 25;
PieChartDefaultValues.accessibility = propDefaultValues.accessibility;
PieChartDefaultValues.animationConfig = propDefaultValues.animationConfig;
PieChartDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
PieChartDefaultValues.colorPalette = propDefaultValues.colorPaletteSequential;
PieChartDefaultValues.sortOrder = propDefaultValues.sortOrderAsc;
PieChartDefaultValues.hoverStyle = propDefaultValues.hoverStyle;
PieChartDefaultValues.clickStyle = propDefaultValues.clickStyle;
PieChartDefaultValues.referenceStyle = propDefaultValues.referenceStyle;
PieChartDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
PieChartDefaultValues.cursor = propDefaultValues.cursor;
PieChartDefaultValues.showTooltip = propDefaultValues.showTooltip;
PieChartDefaultValues.dataLabel = propDefaultValues.dataLabelNormalizedOut;
PieChartDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
PieChartDefaultValues.annotations = propDefaultValues.annotations;
PieChartDefaultValues.suppressEvents = propDefaultValues.suppressEvents;
PieChartDefaultValues.clickHighlight = propDefaultValues.clickHighlight;

const pieChartCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}pie-chart .annotations{pointer-events:none}pie-chart .annotations .handle{pointer-events:all}pie-chart .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}pie-chart .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}pie-chart .hidden{display:none}pie-chart .pie-tooltip{z-index:1}pie-chart .arc text{font:0.625rem sans-serif;text-anchor:middle;cursor:default}pie-chart .pie-dataLabel-highlight{font-size:1.5rem;font-weight:300}pie-chart .pie-dataLabel-note{font-size:0.75rem;fill:#767676}pie-chart .pie-center-title-group{fill:#767676}pie-chart .pie-center-title-group .visa-ui-header--1{font-size:2rem}";
...
const PieChart = class {
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'pie-chart-' + index$1.v4();
  ...
  setTestingAttributes() {
    if (this.unitTest) {
      visaChartsUtils_umd.select(this.pieChartEl)
  ...
  renderRootElements() {
    this.svg = visaChartsUtils_umd.select(this.pieChartEl)
      .select('.visa-viz-d3-pie-container')
      .append('svg')
    ...
    this.tooltipG = visaChartsUtils_umd.select(this.pieChartEl).select('.pie-tooltip');
  ...
  updateInteractionState() {
    ...
    this.update
      ...
      .attr('filter', (d, i, n) => {
      if (!this.accessibility.hideStrokes && !visaChartsUtils_umd.select(n[i]).classed('geometryIsMoving')) {
        ...
        const state = clicked ? 'click' : hovered && !visaChartsUtils_umd.select(n[i]).classed('geometryIsMoving') ? 'hover' : 'rest';
  ...
  setLabelOpacity() {
    ...
    if (this.dataLabel.collisionHideOnly) {
      const labelsAdded = tempLabels.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-added'));
      const labelsRemoved = tempLabels.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-removed'));
      const notesAdded = tempNotes.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-added'));
      const notesRemoved = tempNotes.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-removed'));
  ...
  exitGeometries() {
    ...
    this.exit
      ...
      const me = n[i];
      const interpolator = value.interpolate(me._current, end);
      return t => {
  ...
  drawGeometries() {
    this.update
      ...
      const geometryIsUpdating = checkAttributeTransitions(visaChartsUtils_umd.select(n[i]), [
        {
          attr: 'd',
          newValue: this.arc({
      ...
      .transition('update')
      .duration(this.duration)
      .ease(circle.circleIn)[this.duration ? 'attrTween' : 'attr']('d', (d, i, n) => {
      const me = n[i];
      ...
      const interpolator = value.interpolate(start, end);
      if (!this.duration) {
  ...
  drawReferenceLines() {
    ...
    this.updateRefPie
      ...
      const me = n[i];
      let start = me._current;
      if (visaChartsUtils_umd.select(me).classed('entering')) {
        start = {
          startAngle: 0,
          endAngle: 0,
          innerRadius: Math.max(0, this.innerRadius - 5),
        ...
        visaChartsUtils_umd.select(me).classed('entering', false);
      }
      const interpolator = value.interpolate(start, end);
      if (!this.duration) {
        me._current = interpolator(1);
  ...
  exitLabels(group) {
    ...
    this['exiting' + group]
      ...
      if (!this.duration) {
        visaChartsUtils_umd.select(me).attr('y', this.arc.centroid(end)[1]);
        visaChartsUtils_umd.select(me).text(placement === 'edge' && i === this.preppedData.length - 1 && group !== 'RefLabels'
          ? ''
          : this.showPercentage
      ...
      return t => {
        me._current = interpolator(t);
        visaChartsUtils_umd.select(me).attr('y', this.arc.centroid(me._current)[1]);
        visaChartsUtils_umd.select(me).text(placement === 'edge' && i === this.preppedData.length - 1 && group !== 'RefLabels'
          ? ''
          : this.showPercentage
  ...
  drawDataLabels(group) {
    ...
    if (group === 'Labels' && this.dataLabel.visible && this.dataLabel.collisionHideOnly) {
      ...
      this.bitmaps = resolveLabelCollision({
        labelSelection: visaChartsUtils_umd.select('.empty-stuff-vcc-do-not-use'),
    ...
    this['updating' + group]
      ...
      .transition('update')
      .duration(this.duration)
      .ease(circle.circleIn)[this.duration ? 'attrTween' : 'attr']('x', (d, i, n) => {
      const me = n[i];
      let start = me._current;
      ...
      if (this.dataLabel.visible && this.dataLabel.collisionHideOnly) {
        ...
        this.bitmaps = resolveLabelCollision({
          bitmaps: this.bitmaps,
          labelSelection: visaChartsUtils_umd.select(me),
          avoidMarks: [],
          validPositions,
          offsets,
          accessors: [this.ordinalAccessor],
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: "o-layout is--vertical" }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { class: "pie-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions pie-sub-title vcl-sub-title" }, this.subTitle), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'slice', groupName: 'pie', chartTag: 'pie-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: false, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-pie-container" }), index.h("div", { class: "pie-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
  ...
  get pieChartEl() { return index.getElement(this); }
  static get watchers() { return {
    "mainTitle": ["titleWatcher"],
    "subTitle": ["subtitleWatcher"],
    "highestHeadingLevel": ["headingWatcher"],
    "centerTitle": ["centerTitleWatcher"],
    "centerSubTitle": ["centerTitleWatcher"],
