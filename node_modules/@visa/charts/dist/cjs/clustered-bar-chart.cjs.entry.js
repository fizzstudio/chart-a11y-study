...
class ClusteredBarChartDefaultValues {
}
ClusteredBarChartDefaultValues.mainTitle = 'Clustered Bar Chart Title';
ClusteredBarChartDefaultValues.subTitle = "This is the clustered bar chart's subtitle";
ClusteredBarChartDefaultValues.height = 250;
ClusteredBarChartDefaultValues.width = 675;
ClusteredBarChartDefaultValues.margin = {
  top: 400 * 0.01,
  bottom: 400 * 0.01,
  right: 400 * 0.01,
  left: 400 * 0.01
};
ClusteredBarChartDefaultValues.padding = {
  top: 20,
  bottom: 50,
  right: 50,
  left: 50
};
ClusteredBarChartDefaultValues.ordinalAccessor = 'label';
ClusteredBarChartDefaultValues.valueAccessor = 'value';
ClusteredBarChartDefaultValues.groupAccessor = 'category';
ClusteredBarChartDefaultValues.reverseOrder = false;
ClusteredBarChartDefaultValues.layout = propDefaultValues.layout;
ClusteredBarChartDefaultValues.xAxis = propDefaultValues.xAxis;
ClusteredBarChartDefaultValues.yAxis = propDefaultValues.yAxis;
ClusteredBarChartDefaultValues.wrapLabel = propDefaultValues.wrapLabel;
ClusteredBarChartDefaultValues.colorPalette = propDefaultValues.colorPaletteCategorical;
ClusteredBarChartDefaultValues.hoverStyle = propDefaultValues.hoverStyle;
ClusteredBarChartDefaultValues.clickStyle = propDefaultValues.clickStyle;
ClusteredBarChartDefaultValues.referenceStyle = propDefaultValues.referenceStyle;
ClusteredBarChartDefaultValues.cursor = propDefaultValues.cursor;
ClusteredBarChartDefaultValues.roundedCorner = propDefaultValues.roundedCorner;
ClusteredBarChartDefaultValues.barIntervalRatio = propDefaultValues.barIntervalRatio;
ClusteredBarChartDefaultValues.groupIntervalRatio = propDefaultValues.barIntervalRatio;
ClusteredBarChartDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
ClusteredBarChartDefaultValues.dataLabel = propDefaultValues.dataLabel;
ClusteredBarChartDefaultValues.legend = propDefaultValues.categoryLegend;
ClusteredBarChartDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
ClusteredBarChartDefaultValues.showTooltip = propDefaultValues.showTooltip;
ClusteredBarChartDefaultValues.accessibility = propDefaultValues.accessibility;
ClusteredBarChartDefaultValues.animationConfig = propDefaultValues.animationConfig;
ClusteredBarChartDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
ClusteredBarChartDefaultValues.referenceLines = propDefaultValues.referenceLines;
ClusteredBarChartDefaultValues.annotations = propDefaultValues.annotations;
ClusteredBarChartDefaultValues.clickHighlight = propDefaultValues.clickHighlight;
ClusteredBarChartDefaultValues.suppressEvents = propDefaultValues.suppressEvents;

const clusteredBarChartCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}clustered-bar-chart{cursor:default}clustered-bar-chart .annotations{pointer-events:none}clustered-bar-chart .annotations .handle{pointer-events:all}clustered-bar-chart .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}clustered-bar-chart .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}clustered-bar-chart .hidden{display:none}clustered-bar-chart #visa-viz-d3-clustered-bar-container{clear:both}clustered-bar-chart .clustered-bar-legend{font-size:1em;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-wrap:wrap;flex-wrap:wrap}clustered-bar-chart .clustered-bar-legend .legend{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start;margin-right:10px}clustered-bar-chart .clustered-bar-legend .key-dot{margin:3px 8px}clustered-bar-chart .light .grid line{stroke:#767676;stroke-opacity:1;stroke-width:0.8;stroke-dasharray:4, 4}clustered-bar-chart .light .grid path{stroke-width:0}clustered-bar-chart .light .axis{font-size:12px}clustered-bar-chart .light .axis .tick text{fill:#767676}clustered-bar-chart .light .axis .tick line{stroke:#767676}clustered-bar-chart .light .axis-label{text-anchor:middle;font:1rem sans-serif}clustered-bar-chart .light .y.axis path{stroke:#767676;opacity:0}clustered-bar-chart .light .x.axis path{stroke:#767676}clustered-bar-chart .dark .grid line{stroke:lightgrey;stroke-opacity:0.7;shape-rendering:crispEdges}clustered-bar-chart .dark .grid path{stroke-width:0}clustered-bar-chart .dark .axis{font-size:12px}clustered-bar-chart .dark .axis .tick line{stroke:lightgrey}clustered-bar-chart .dark .axis .tick text{fill:grey}clustered-bar-chart .dark .axis path{stroke:black}clustered-bar-chart .dark .axis-label{text-anchor:middle;font:1rem sans-serif}clustered-bar-chart .dark .o-layout--chart svg{background:black}clustered-bar-chart .dark .o-layout--chart svg .clustered-bar-dataLabel-vertical{text-anchor:middle}clustered-bar-chart .dark .o-layout--chart svg .clustered-bar-dataLabel-horizontal{text-anchor:start}";
...
const ClusteredBarChart = class {
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'clustered-bar-chart-' + index$1.v4();
  ...
  prepareScales() {
    const minBarValue = this.minValueOverride && this.minValueOverride < min.min(this.data, d => d[this.valueAccessor])
      ? this.minValueOverride
      : min.min(this.data, d => d[this.valueAccessor]);
    const maxBarValue = this.maxValueOverride && this.maxValueOverride > max.max(this.data, d => d[this.valueAccessor])
      ? this.maxValueOverride
      : max.max(this.data, d => d[this.valueAccessor]);
  ...
  renderRootElements() {
    this.svg = visaChartsUtils_umd.select(this.clusteredBarChartEl)
    ...
    this.legendG = visaChartsUtils_umd.select(this.clusteredBarChartEl)
      .select('.clustered-bar-legend')
      .append('svg');
    this.tooltipG = visaChartsUtils_umd.select(this.clusteredBarChartEl).select('.clustered-bar-tooltip');
    this.references = this.rootG.append('g').attr('class', 'clustered-bar-reference-line-group');
  }
  setTestingAttributes() {
    if (this.unitTest) {
      visaChartsUtils_umd.select(this.clusteredBarChartEl)
        .select('.visa-viz-d3-clustered-bar-container')
  ...
  enterGeometries() {
    ...
    if (!this.defaults) {
      this.enter
        ...
        const p = visaChartsUtils_umd.select(n[i].parentNode);
  ...
  exitGeometries() {
    ...
    this.exit
      ...
      const self = visaChartsUtils_umd.select(n[i]);
  ...
  drawGeometries() {
    ...
    this.update
      ...
      .transition('update')
      .duration((_, i, n) => {
      return visaChartsUtils_umd.select(n[i]).classed('entering') ? this.duration / 2 : this.duration;
    })
      .delay((_, i, n) => {
      return visaChartsUtils_umd.select(n[i]).classed('entering') ? this.duration / 2 : 0;
    })
      .ease(circle.circleIn)
      .attr(valueAxis, d => this[valueAxis](Math[choice](0, d[this.valueAccessor])))
      .attr(valueDimension, d => Math.abs(this.layout === 'vertical'
  ...
  setLabelPosition() {
    ...
    const enteringOnly = this.enterLabels.filter((_, i, n) => {
      return visaChartsUtils_umd.select(n[i]).classed('entering');
    });
  ...
  render() {
    ...
    // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: `o-layout is--${this.layout} ${theme}` }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { class: "clustered-bar-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions clustered-bar-sub-title vcl-sub-title" }, this.subTitle), index.h("div", { class: "clustered-bar-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'bar', groupName: 'cluster', chartTag: 'clustered-bar-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation // on bar this requires checking for groupAccessor
      : true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-clustered-bar-container" }), index.h("div", { class: "clustered-bar-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get clusteredBarChartEl() { return index.getElement(this); }
  static get watchers() { return {
    ...
    "reverseOrder": ["reverseOrderWatcher"],
    "xAxis": ["xAxisWatcher"],
    "yAxis": ["yAxisWatcher"],
    ...
    "groupIntervalRatio": ["groupIntervalRatioWatcher"],
...
ClusteredBarChart.style = clusteredBarChartCss;

exports.clustered_bar_chart = ClusteredBarChart;
