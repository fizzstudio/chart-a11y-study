...
const time = require('./time-81cd634c.js');
...
class LineChartDefaultValues {
}
LineChartDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
LineChartDefaultValues.mainTitle = 'Line Chart Title';
LineChartDefaultValues.subTitle = "This is the line chart's subtitle";
LineChartDefaultValues.height = 300;
LineChartDefaultValues.width = 650;
LineChartDefaultValues.margin = {
  top: 300 * 0.01,
  bottom: 300 * 0.01,
  right: 650 * 0.01,
  left: 650 * 0.01
};
LineChartDefaultValues.padding = {
  top: 20,
  bottom: 50,
  right: 50,
  left: 50
};
LineChartDefaultValues.ordinalAccessor = 'label';
LineChartDefaultValues.valueAccessor = 'value';
LineChartDefaultValues.seriesAccessor = 'series';
LineChartDefaultValues.accessibility = propDefaultValues.accessibility;
LineChartDefaultValues.animationConfig = propDefaultValues.animationConfig;
LineChartDefaultValues.xAxis = propDefaultValues.xAxisDate;
LineChartDefaultValues.yAxis = propDefaultValues.yAxis;
LineChartDefaultValues.showBaselineX = propDefaultValues.showBaselineTrue;
LineChartDefaultValues.wrapLabel = propDefaultValues.wrapLabel;
LineChartDefaultValues.colorPalette = propDefaultValues.colorPaletteCategorical;
LineChartDefaultValues.hoverStyle = propDefaultValues.hoverStyle;
LineChartDefaultValues.clickStyle = propDefaultValues.clickStyle;
LineChartDefaultValues.referenceStyle = propDefaultValues.referenceStyle;
LineChartDefaultValues.strokeWidth = propDefaultValues.strokeWidth2;
LineChartDefaultValues.showDots = propDefaultValues.showDots;
LineChartDefaultValues.dotRadius = propDefaultValues.dotRadius4;
LineChartDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
LineChartDefaultValues.cursor = propDefaultValues.cursor;
LineChartDefaultValues.dataLabel = propDefaultValues.dataLabelLine;
LineChartDefaultValues.seriesLabel = propDefaultValues.seriesLabel;
LineChartDefaultValues.legend = propDefaultValues.categoryLegend;
LineChartDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
LineChartDefaultValues.secondaryLines = propDefaultValues.secondaryLines;
LineChartDefaultValues.showTooltip = propDefaultValues.showTooltip;
LineChartDefaultValues.suppressEvents = propDefaultValues.suppressEvents;
LineChartDefaultValues.referenceLines = propDefaultValues.referenceLines;
LineChartDefaultValues.annotations = propDefaultValues.annotations;
LineChartDefaultValues.clickHighlight = propDefaultValues.clickHighlight;

const lineChartCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}line-chart{cursor:default}line-chart .annotations{pointer-events:none}line-chart .annotations .handle{pointer-events:all}line-chart .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}line-chart .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}line-chart .hidden{display:none}line-chart .axis{font-size:12px}line-chart .axis text{fill:#767676}line-chart .axis-label{text-anchor:middle;font:1rem sans-serif}line-chart .axis path{stroke:#767676}line-chart .grid line{stroke:#767676;stroke-opacity:0.6;shape-rendering:crispEdges;stroke-dasharray:4, 4}line-chart .grid path{stroke-width:0;stroke:#767676}line-chart .line-group{-webkit-transition:opacity 0.5s linear;transition:opacity 0.5s linear}line-chart .line-group__inactive{opacity:0}line-chart .line-group .line-plot{fill:none}line-chart .line-group .dot{stroke:#ffffff}line-chart .line-group .line-series-label{font-size:1em}line-chart .line-legend{font-size:1em;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}line-chart .line-legend .legend{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}";

const { getAccessibleStrokes, ensureTextContrast, createTextStrokeFilter, findTagLevel, prepareRenderChange, initializeDescriptionRoot, initializeElementAccess, setElementFocusHandler, setElementAccessID, setAccessibilityController, hideNonessentialGroups, setAccessTitle, setAccessSubtitle, setAccessLongDescription, setAccessExecutiveSummary, setAccessPurpose, setAccessContext, setAccessStatistics, setAccessStructure, setAccessChartCounts, setAccessXAxis, setAccessYAxis, setAccessAnnotation, retainAccessFocus, checkAccessFocus, setElementInteractionAccessState, setAccessibilityDescriptionWidth, annotate, chartAccessors, checkInteraction, checkClicked, checkHovered, convertVisaColor, drawAxis, drawGrid, drawLegend, setLegendInteractionState, drawTooltip, formatDataLabel, getColors, getLicenses, getPadding, getScopedData, initTooltipStyle, overrideTitleTooltip, placeDataLabels, resolveLines, scopeDataKeys, transitionEndAll, visaColors, validateAccessibilityProps, roundTo, resolveLabelCollision } = visaChartsUtils_umd.visaChartsUtils_umd;
const LineChart = class {
  constructor(hostRef) {
    ...
    this.mainTitle = LineChartDefaultValues.mainTitle;
    this.subTitle = LineChartDefaultValues.subTitle;
    this.height = LineChartDefaultValues.height;
    this.width = LineChartDefaultValues.width;
    this.highestHeadingLevel = LineChartDefaultValues.highestHeadingLevel;
    this.margin = LineChartDefaultValues.margin;
    this.padding = LineChartDefaultValues.padding;
    this.ordinalAccessor = LineChartDefaultValues.ordinalAccessor;
    this.valueAccessor = LineChartDefaultValues.valueAccessor;
    this.seriesAccessor = LineChartDefaultValues.seriesAccessor;
    // Axis (3/7)
    this.xAxis = LineChartDefaultValues.xAxis;
    this.yAxis = LineChartDefaultValues.yAxis;
    this.wrapLabel = LineChartDefaultValues.wrapLabel;
    this.showBaselineX = LineChartDefaultValues.showBaselineX;
    // Color & Shape (4/7)
    this.colorPalette = LineChartDefaultValues.colorPalette;
    this.hoverStyle = LineChartDefaultValues.hoverStyle;
    this.clickStyle = LineChartDefaultValues.clickStyle;
    this.referenceStyle = LineChartDefaultValues.referenceStyle;
    this.cursor = LineChartDefaultValues.cursor;
    this.hoverOpacity = LineChartDefaultValues.hoverOpacity;
    this.animationConfig = LineChartDefaultValues.animationConfig;
    this.strokeWidth = LineChartDefaultValues.strokeWidth;
    this.showDots = LineChartDefaultValues.showDots;
    this.dotRadius = LineChartDefaultValues.dotRadius;
    // Data label (5/7)
    this.dataLabel = LineChartDefaultValues.dataLabel;
    this.showTooltip = LineChartDefaultValues.showTooltip;
    this.tooltipLabel = LineChartDefaultValues.tooltipLabel;
    this.accessibility = LineChartDefaultValues.accessibility;
    this.legend = LineChartDefaultValues.legend;
    this.annotations = LineChartDefaultValues.annotations;
    this.seriesLabel = LineChartDefaultValues.seriesLabel;
    this.referenceLines = LineChartDefaultValues.referenceLines;
    this.secondaryLines = LineChartDefaultValues.secondaryLines;
    // Interactivity (7/7)
    this.suppressEvents = LineChartDefaultValues.suppressEvents;
    this.clickHighlight = LineChartDefaultValues.clickHighlight;
    // Testing (8/7)
    this.unitTest = false;
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'line-chart-' + index$1.v4();
  ...
  prepareScales() {
    ...
    const minValue = min.min(this.data, d => parseFloat(d[this.valueAccessor]));
    const maxValue = max.max(this.data, d => parseFloat(d[this.valueAccessor]));
    ...
    if (this.data[0][this.ordinalAccessor] instanceof Date) {
      const maxDate = max.max(this.data, d => d[this.ordinalAccessor]);
      const minDate = min.min(this.data, d => d[this.ordinalAccessor]);
      const timeDiffInMilliseconds = time.millisecond.count(minDate, maxDate);
      const genericTimePadding = timeDiffInMilliseconds / 12;
      this.x = time.scaleTime()
      ...
      if (this.xAxis.unit) {
        ...
        this.x.domain([
          new Date(time.millisecond.offset(minDate, -genericTimePadding)),
          new Date(time.millisecond.offset(maxDate, genericTimePadding))
        ]);
      }
    }
    else {
  ...
  renderRootElements() {
    this.svg = visaChartsUtils_umd.select(this.lineChartEl)
    ...
    this.legendG = visaChartsUtils_umd.select(this.lineChartEl)
      .select('.line-legend')
      .append('svg');
    this.tooltipG = visaChartsUtils_umd.select(this.lineChartEl).select('.line-tooltip');
  ...
  setTestingAttributes() {
    if (this.unitTest) {
      visaChartsUtils_umd.select(this.lineChartEl)
        .select('.visa-viz-d3-line-container')
  ...
  updatePoints() {
    ...
    if (this.interpolating) {
      ...
      this.updateDots
        ...
        .attr('data-index', d => {
        return this.xIndex(d[this.ordinalAccessor] instanceof Date ? d[this.ordinalAccessor].getTime() : d[this.ordinalAccessor]);
      });
    }
    else {
      this.updateDots
  ...
  drawSeriesLabels() {
    ...
    this.seriesLabelUpdate.text((d, i) => this.secondaryLines.keys.includes(d.key) && !this.secondaryLines.showSeriesLabel
      ? ''
      : this.labelDetails.label
  ...
  enterDataLabels() {
    ...
    if (this.interpolating) {
      ...
      this.updatingLabels.attr('opacity', d => d.enter
        ? Number.EPSILON
  ...
  setLabelOpacity() {
    ...
    if (addCollisionClass) {
      const labelsAdded = this.updatingLabels
        ...
        .transition()
        .duration(0);
      const labelsRemoved = this.updatingLabels.filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-removed')); // .transition().duration(0);
      const validPositions = hideOnly
        ? ['middle']
        : collisionPlacement && this.collisionSettings[collisionPlacement] // check whether placement provided maps correctly
          ? this.collisionSettings[collisionPlacement].validPositions
  ...
  bindLegendInteractivity() {
    visaChartsUtils_umd.select(this.lineChartEl)
      .selectAll('.legend')
      .on('click', !this.suppressEvents && this.legend.interactive && this.seriesInteraction
      ? (d, i, n) => {
        if (d.values) {
          this.onClickHandler(d.values[0], n[i]);
        }
      ...
      : null)
      .on('mouseover', !this.suppressEvents && this.legend.interactive && this.seriesInteraction
      ? (d, i, n) => {
        if (d.values) {
      ...
      : null)
      .on('mouseout', !this.suppressEvents && this.legend.interactive && this.seriesInteraction
  ...
  render() {
    ...
    // // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: "o-layout" }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { class: "line-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions line-sub-title vcl-sub-title" }, this.subTitle), index.h("div", { class: "line-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'line', chartTag: 'line-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-line-container" }), index.h("div", { class: "line-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get lineChartEl() { return index.getElement(this); }
