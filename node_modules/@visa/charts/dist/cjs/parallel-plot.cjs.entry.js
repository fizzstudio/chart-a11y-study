...
const index = require('./index-8ff97be1.js');
const max = require('./max-345382d7.js');
const min = require('./min-58e10159.js');
const band = require('./band-5a058c34.js');
const linear = require('./linear-aa74902e.js');
const visaChartsUtils_umd = require('./visa-charts-utils.umd-3fa58d0c.js');
const index$1 = require('./index-61a3350e.js');
const year = require('./year-f58be3f7.js');
const line = require('./line-44951927.js');
const circle = require('./circle-4a84a6a8.js');
require('./range-29edd0b2.js');
require('./value-b7bc3cc2.js');
require('./constant-7c4eeb3b.js');
require('./point-8c60c2dc.js');
 ...
 *
 **/
const { propDefaultValues } = visaChartsUtils_umd.visaChartsUtils_umd;
class ParallelPlotDefaultValues {
}
ParallelPlotDefaultValues.mainTitle = 'Parallel Plot Title';
ParallelPlotDefaultValues.subTitle = "This is the parallel plot's subtitle";
ParallelPlotDefaultValues.height = 300;
ParallelPlotDefaultValues.width = 500;
ParallelPlotDefaultValues.margin = {
  top: 300 * 0.01,
  bottom: 300 * 0.01,
  right: 500 * 0.01,
  left: 500 * 0.01
};
ParallelPlotDefaultValues.padding = {
  top: 20,
  bottom: 50,
  right: 100,
  left: 75
};
ParallelPlotDefaultValues.ordinalAccessor = 'label';
ParallelPlotDefaultValues.valueAccessor = 'value';
ParallelPlotDefaultValues.seriesAccessor = 'series';
ParallelPlotDefaultValues.accessibility = propDefaultValues.accessibility;
ParallelPlotDefaultValues.animationConfig = propDefaultValues.animationConfig;
ParallelPlotDefaultValues.highestHeadingLevel = propDefaultValues.highestHeadingLevel;
ParallelPlotDefaultValues.xAxis = propDefaultValues.xAxis;
ParallelPlotDefaultValues.yAxis = propDefaultValues.yAxis;
ParallelPlotDefaultValues.showBaselineX = propDefaultValues.showBaselineFalse;
ParallelPlotDefaultValues.wrapLabel = propDefaultValues.wrapLabel;
ParallelPlotDefaultValues.colorPalette = propDefaultValues.colorPaletteCategorical;
ParallelPlotDefaultValues.hoverStyle = propDefaultValues.hoverStyle;
ParallelPlotDefaultValues.clickStyle = propDefaultValues.clickStyle;
ParallelPlotDefaultValues.referenceStyle = propDefaultValues.referenceStyle;
ParallelPlotDefaultValues.strokeWidth = propDefaultValues.strokeWidth1;
ParallelPlotDefaultValues.showDots = propDefaultValues.showDots;
ParallelPlotDefaultValues.dotRadius = propDefaultValues.dotRadius4;
ParallelPlotDefaultValues.hoverOpacity = propDefaultValues.hoverOpacity;
ParallelPlotDefaultValues.cursor = propDefaultValues.cursor;
ParallelPlotDefaultValues.dataLabel = propDefaultValues.dataLabelBottomRight;
ParallelPlotDefaultValues.seriesLabel = propDefaultValues.seriesLabel;
ParallelPlotDefaultValues.legend = propDefaultValues.hiddenLegend;
ParallelPlotDefaultValues.tooltipLabel = propDefaultValues.tooltipLabel;
ParallelPlotDefaultValues.secondaryLines = propDefaultValues.secondaryLines;
ParallelPlotDefaultValues.showTooltip = propDefaultValues.showTooltip;
ParallelPlotDefaultValues.suppressEvents = propDefaultValues.suppressEvents;
ParallelPlotDefaultValues.referenceLines = propDefaultValues.referenceLines;
ParallelPlotDefaultValues.annotations = propDefaultValues.annotations;
ParallelPlotDefaultValues.clickHighlight = propDefaultValues.clickHighlight;

const parallelPlotCss = ".o-layout{width:100%;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.o-layout--chart{width:100%}.is--vertical .o-layout--chart{width:90%}parallel-plot{cursor:default}parallel-plot .annotations{pointer-events:none}parallel-plot .annotations .handle{pointer-events:all}parallel-plot .screen-reader-info{position:absolute;left:-9999px;top:auto;width:1px;height:1px;overflow:hidden}parallel-plot .data-table-link{color:#767676;text-decoration:none;font-size:12px;margin-left:5%}parallel-plot .hidden{display:none}parallel-plot .axis{font-size:12px}parallel-plot .axis text{fill:#767676}parallel-plot .axis-label{text-anchor:middle;font:1rem sans-serif}parallel-plot .axis path{stroke:#767676}parallel-plot .grid line{stroke:#767676;shape-rendering:crispEdges}parallel-plot .grid path{stroke-width:0;stroke:#767676}parallel-plot .grid.left line{stroke-dasharray:4, 4;stroke-opacity:0.6}parallel-plot .parallel-group{-webkit-transition:opacity 0.5s linear;transition:opacity 0.5s linear}parallel-plot .parallel-group__inactive{opacity:0}parallel-plot .parallel-group .parallel-plot{fill:none}parallel-plot .parallel-group .dot{stroke:#ffffff}parallel-plot .parallel-group .parallel-series-label{font-size:1em}parallel-plot .parallel-legend{font-size:1em;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}parallel-plot .parallel-legend .legend{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}";

const { getAccessibleStrokes, ensureTextContrast, createTextStrokeFilter, findTagLevel, prepareRenderChange, initializeDescriptionRoot, initializeElementAccess, setElementFocusHandler, setElementAccessID, setAccessibilityController, hideNonessentialGroups, setAccessTitle, setAccessSubtitle, setAccessLongDescription, setAccessExecutiveSummary, setAccessPurpose, setAccessContext, setAccessStatistics, setAccessChartCounts, setAccessXAxis, setAccessYAxis, setAccessStructure, setAccessAnnotation, retainAccessFocus, checkAccessFocus, setElementInteractionAccessState, setAccessibilityDescriptionWidth, annotate, chartAccessors, checkInteraction, checkClicked, checkHovered, convertVisaColor, drawAxis, drawGrid, drawLegend, setLegendInteractionState, drawTooltip, formatDataLabel, getColors, getLicenses, getPadding, getScopedData, initTooltipStyle, overrideTitleTooltip, placeDataLabels, resolveLines, scopeDataKeys, transitionEndAll, visaColors, validateAccessibilityProps, roundTo, getTextWidth, resolveLabelCollision } = visaChartsUtils_umd.visaChartsUtils_umd;
const ParallelPlot = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickEvent = index.createEvent(this, "clickEvent", 7);
    this.hoverEvent = index.createEvent(this, "hoverEvent", 7);
    this.mouseOutEvent = index.createEvent(this, "mouseOutEvent", 7);
    this.initialLoadEvent = index.createEvent(this, "initialLoadEvent", 7);
    this.drawStartEvent = index.createEvent(this, "drawStartEvent", 7);
    this.drawEndEvent = index.createEvent(this, "drawEndEvent", 7);
    this.transitionEndEvent = index.createEvent(this, "transitionEndEvent", 7);
    // Chart Attributes (1/7)
    this.mainTitle = ParallelPlotDefaultValues.mainTitle;
    this.subTitle = ParallelPlotDefaultValues.subTitle;
    this.height = ParallelPlotDefaultValues.height;
    this.width = ParallelPlotDefaultValues.width;
    this.highestHeadingLevel = ParallelPlotDefaultValues.highestHeadingLevel;
    this.margin = ParallelPlotDefaultValues.margin;
    this.padding = ParallelPlotDefaultValues.padding;
    this.ordinalAccessor = ParallelPlotDefaultValues.ordinalAccessor;
    this.valueAccessor = ParallelPlotDefaultValues.valueAccessor;
    this.seriesAccessor = ParallelPlotDefaultValues.seriesAccessor;
    // Axis (3/7)
    this.xAxis = ParallelPlotDefaultValues.xAxis;
    this.yAxis = ParallelPlotDefaultValues.yAxis;
    this.wrapLabel = ParallelPlotDefaultValues.wrapLabel;
    this.showBaselineX = ParallelPlotDefaultValues.showBaselineX;
    // Color & Shape (4/7)
    this.colorPalette = ParallelPlotDefaultValues.colorPalette;
    this.hoverStyle = ParallelPlotDefaultValues.hoverStyle;
    this.clickStyle = ParallelPlotDefaultValues.clickStyle;
    this.referenceStyle = ParallelPlotDefaultValues.referenceStyle;
    this.cursor = ParallelPlotDefaultValues.cursor;
    this.hoverOpacity = ParallelPlotDefaultValues.hoverOpacity;
    this.animationConfig = ParallelPlotDefaultValues.animationConfig;
    this.strokeWidth = ParallelPlotDefaultValues.strokeWidth;
    this.showDots = ParallelPlotDefaultValues.showDots;
    this.dotRadius = ParallelPlotDefaultValues.dotRadius;
    // Data label (5/7)
    this.dataLabel = ParallelPlotDefaultValues.dataLabel;
    this.showTooltip = ParallelPlotDefaultValues.showTooltip;
    this.tooltipLabel = ParallelPlotDefaultValues.tooltipLabel;
    this.accessibility = ParallelPlotDefaultValues.accessibility;
    this.legend = ParallelPlotDefaultValues.legend;
    this.annotations = ParallelPlotDefaultValues.annotations;
    this.seriesLabel = ParallelPlotDefaultValues.seriesLabel;
    this.referenceLines = ParallelPlotDefaultValues.referenceLines;
    this.secondaryLines = ParallelPlotDefaultValues.secondaryLines;
    // Interactivity (7/7)
    this.suppressEvents = ParallelPlotDefaultValues.suppressEvents;
    this.clickHighlight = ParallelPlotDefaultValues.clickHighlight;
    // Testing (8/7)
    this.unitTest = false;
    ...
    this.time = {
      timehour: year.hour,
      timeday: year.day,
      timeweek: year.sunday,
      timemonth: year.month,
      timeyear: year.year
    };
    ...
    this.handleDotStroke = (d, i, n) => {
      if (!this.accessibility.hideStrokes) {
        ...
        const baseColor = visaChartsUtils_umd.select(n[i].parentNode).attr('fill');
        const color = clicked && this.clickStyle.color
          ...
          : clicked
            ...
            : hovered && this.hoverStyle.color
              ...
              : baseColor;
        visaChartsUtils_umd.select(n[i]).attr('stroke-width', this.calculateStrokeWidth(d));
        visaChartsUtils_umd.select(n[i]).attr('fill', color);
        return this.strokes[color.toLowerCase()];
      }
      return null;
    };
    this.handleLineStroke = (data, i) => {
    ...
    this.handleSeriesTextFill = (data, i) => {
    ...
    this.calculateStrokeWidth = (data, useChildData) => {
    ...
    this.handleStrokeDasharray = (d, i) => {
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'parallel-plot-' + index$1.v4();
  ...
  prepareScales() {
    if (this.nest) {
      ...
      this.interpolating.multiYScale = Object.assign({}, this.multiYScale);
      this.interpolating.x = this.x.domain(oldXDomain).range(oldXRange);
      this.interpolating.y = linear.linear()
        .domain(oldYDomain)
        .range(oldYRange);
      this.interpolating.line = line.line()
    ...
    this.extent = {};
    this.extent.minValue = min.min(this.data, d => parseFloat(d[this.valueAccessor]));
    this.extent.maxValue = max.max(this.data, d => parseFloat(d[this.valueAccessor]));
  ...
  validateSeriesLabels() {
    this.labelDetails = Object.assign({}, this.seriesLabel);
  ...
  renderRootElements() {
    this.svg = visaChartsUtils_umd.select(this.parallelChartEl)
  ...
  renderChartRootElemets() {
    ...
    this.legendG = visaChartsUtils_umd.select(this.parallelChartEl)
      .select('.parallel-legend')
      .append('svg');
    this.tooltipG = visaChartsUtils_umd.select(this.parallelChartEl).select('.parallel-tooltip');
  ...
  setTestingAttributes() {
    if (this.unitTest) {
      visaChartsUtils_umd.select(this.parallelChartEl)
        .select('.visa-viz-d3-parallel-container')
  ...
  drawYAxis() {
    this.yUpdate
      .each((d, i, n) => {
      const ticks = this.yAxis.scales === 'individual'
      ...
      const hideMe = domain[0] === domain[1] ? true : i === 0 || this.yAxis.scales === 'individual' ? !this.yAxis.visible : true;
      drawAxis({
        root: visaChartsUtils_umd.select(n[i]),
        height: this.innerPaddedHeight,
        width: this.innerPaddedWidth,
  ...
  drawXGrid() {
    drawGrid(this.gridG, this.innerPaddedHeight, this.innerPaddedWidth, this.x, false, false, this.xAxis.tickInterval, this.duration);
  }
  drawYGrid() {
  ...
  enterChartLines() {
    ...
    this.enterLines
      ...
      .on('click', !this.suppressEvents && this.seriesInteraction
      ? (d, i, n) => {
        if (d.values) {
      ...
      : null)
      .on('mouseover', !this.suppressEvents && this.seriesInteraction
      ? (d, i, n) => {
        if (d.values) {
  ...
  updateChartLines() {
    ...
    this.updateLines
      ...
      if (!this.seriesInteraction) {
        ...
        return checkInteraction(d.values[0], this.secondaryLines.opacity, Math.min(this.secondaryLines.opacity, this.hoverOpacity), this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
      }
      else {
        return checkInteraction(d.values[0], // use first data point of each line to decide interaction highlight
        lineOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
      }
    });
  }
  exitChartLines() {
  ...
  drawChartLines() {
    if (this.interpolating) {
      this.updateLines.attr('d', (d, i, n) => {
        if (visaChartsUtils_umd.select(n[i]).classed('entering')) {
  ...
  updatePoints() {
    ...
    if (this.interpolating) {
      ...
      this.updateDots
        ...
        .attr('opacity', d => {
        return checkInteraction(d, dotOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
      });
    }
    else {
      this.updateDots
  ...
  drawPoints() {
    ...
    if (this.interpolating) {
      ...
      updateTransition = this.updateDots
        ...
        .attr('data-translate-x', this.margin.left + this.padding.left)
        .attr('data-translate-y', this.margin.top + this.padding.top)
        .attr('data-r', d => checkClicked(d, this.clickHighlight, this.innerInteractionKeys)
        ? this.dotRadius +
          (this.clickStyle && this.clickStyle.strokeWidth ? parseFloat('' + this.clickStyle.strokeWidth) / 2 : 1)
        : checkHovered(d, this.hoverHighlight, this.innerInteractionKeys)
          ? this.dotRadius +
          ...
          : this.secondaryLines.keys.includes(d[this.seriesAccessor])
            ? this.dotRadius + 0.5
            : this.dotRadius + parseFloat('' + this.strokeWidth) / 2)
        .attr('r', d => checkClicked(d, this.clickHighlight, this.innerInteractionKeys)
        ? this.dotRadius +
          (this.clickStyle && this.clickStyle.strokeWidth ? parseFloat('' + this.clickStyle.strokeWidth) / 2 : 1)
        : checkHovered(d, this.hoverHighlight, this.innerInteractionKeys)
          ? this.dotRadius +
  ...
  enterSeriesLabels() {
    ...
    this.seriesLabelEnter
      ...
      if (this.yAxis.scales === 'individual') {
        return this.isRight
          ? this.multiYScale[d.values[d.values.length - 1][this.ordinalAccessor]].y(d.values[d.values.length - 1][this.valueAccessor])
      ...
      const seriesLabelOpacity = !this.seriesLabel.visible
        ...
        : this.secondaryLines.keys.includes(d.key)
          ...
          : 1;
      return checkInteraction(d.values[0], seriesLabelOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
        ? 0
        : Number.EPSILON;
    });
  }
  updateSeriesLabels() {
    ...
    this.seriesLabelUpdate
      ...
      if (!this.seriesInteraction) {
        ...
        return checkInteraction(d.values[0], seriesLabelOpacity, Math.min(this.secondaryLines.opacity, this.hoverOpacity), this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
      }
      else {
        return checkInteraction(d.values[0], seriesLabelOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
      }
    });
  }
  exitSeriesLabels() {
  ...
  drawSeriesLabels() {
    ...
    const seriesUpdate = this.seriesLabelUpdate
      .attr('fill', this.handleSeriesTextFill)
      .text((d, i) => this.secondaryLines.keys.includes(d.key) && !this.secondaryLines.showSeriesLabel
      ? ''
      : this.labelDetails.label
        ? this.labelDetails.label[i]
        : d.key)
      .style('visibility', (_, i, n) => this.labelDetails.placement === 'auto' || this.labelDetails.collisionHideOnly
      ? visaChartsUtils_umd.select(n[i]).style('visibility')
      : null)
    ...
    if (this.dataLabel.placement === 'auto') {
      this.updatingLabels.each((d, i, n) => {
        ...
        if (!d.enter &&
          ...
          (d['auto-x'] || d['auto-x'] === 0) &&
          (d['auto-y'] || d['auto-y'] === 0)) {
          visaChartsUtils_umd.select(n[i])
            .attr('x', +visaChartsUtils_umd.select(n[i]).attr('x') + (+d['auto-x'] || 0))
            .attr('y', +visaChartsUtils_umd.select(n[i]).attr('y') + (+d['auto-y'] || 0))
    ...
    if (this.interpolating) {
      ...
      this.updatingLabels
        ...
        const targetOpacity = d.exit
          ? 0
          : checkInteraction(d, 1, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
            ? 0
            : 1;
        const parentOpacity = +visaChartsUtils_umd.select(n[i].parentNode).attr('opacity');
        visaChartsUtils_umd.select(n[i]).attr('data-hidden', parentOpacity === 0 || targetOpacity === 0 ? 'true' : null);
  ...
  drawDataLabels() {
    ...
    if (this.interpolating) {
      updateChildren = this.updatingLabels
        .style('visibility', (d, i, n) => this.dataLabel.placement === 'auto' || this.dataLabel.collisionHideOnly
        ? d.hidden
          ? 'hidden'
          : visaChartsUtils_umd.select(n[i]).style('visibility')
        : null)
    ...
    const yAxisTexts = this.yUpdate
      .selectAll('.y.axis')
      .filter((_, i, n) => +visaChartsUtils_umd.select(n[i]).attr('opacity') >= 0.0001) // this filter has an issue with transitions
      .selectAll('text')
      .attr('data-fill', true)
      ...
      const textHeight = Math.max(fontSize - 1, 1); // clone.getBBox().height;
      const textWidth = getTextWidth(textElement.textContent, fontSize, true, style.fontFamily);
      visaChartsUtils_umd.select(textElement)
        .attr('data-x', +visaChartsUtils_umd.select(textElement).attr('x'))
    ...
    updateChildren.call(transitionEndAll, () => {
      ...
      this.updatingLabels.each((d, i, n) => {
        ...
        this.hiddenHash[`${d[this.ordinalAccessor]}-${d[this.seriesAccessor] || 'b'}`] = {
          'data-label-hidden': visaChartsUtils_umd.select(n[i]).attr('data-label-hidden') === 'true',
          x: +visaChartsUtils_umd.select(n[i]).attr('x') - +visaChartsUtils_umd.select(n[i]).attr('data-x'),
          y: +visaChartsUtils_umd.select(n[i]).attr('y') - +visaChartsUtils_umd.select(n[i]).attr('data-y'),
          'text-anchor': visaChartsUtils_umd.select(n[i]).attr('text-anchor')
        };
      });
    });
  }
  updateInteractionState() {
    ...
    this.updateDots.each((d, i, n) => {
      if (!d.enter && !d.enterWholeGroup && !d.exit && !d.exitWholeGroup) {
        visaChartsUtils_umd.select(n[i]).attr('opacity', () => {
          return checkInteraction(d, dotOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys);
        });
      }
    });
  ...
  setSeriesLabelOpacity() {
    ...
    this.seriesLabelUpdate.each((d, i, n) => {
      const me = visaChartsUtils_umd.select(n[i]);
      ...
      if (!me.classed('entering')) {
        me.attr('opacity', () => {
          ...
          // check if innerInteractionKeys includes seriesAccessor, if not then don't check seriesLabel for interaction
          if (!this.seriesInteraction) {
            visaChartsUtils_umd.select(n[i]).attr('data-hidden', seriesLabelOpacity === 0 ? 'true' : null);
            if (prevOpacity !== seriesLabelOpacity && (this.labelDetails.placement === 'auto' || hideOnly)) {
              if (seriesLabelOpacity === 1) {
                ...
                visaChartsUtils_umd.select(n[i]).classed('collision-removed', true);
              }
            }
            return seriesLabelOpacity;
          }
          else if (this.secondaryLines.keys.includes(d.key)) {
            const targetOpacity = checkInteraction(d.values[0], seriesLabelOpacity, Math.min(this.secondaryLines.opacity, this.hoverOpacity), this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
              ? 0
              : 1;
            visaChartsUtils_umd.select(n[i]).attr('data-hidden', targetOpacity === 0 ? 'true' : null);
            ...
            const targetOpacity = checkInteraction(d.values[0], seriesLabelOpacity, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
              ? 0
              : 1;
            visaChartsUtils_umd.select(n[i]).attr('data-hidden', targetOpacity === 0 ? 'true' : null);
            if (((targetOpacity === 1 && styleVisibility === 'hidden') || prevOpacity !== targetOpacity) &&
    ...
    if (addCollisionClass) {
      const labelsAdded = this.seriesLabelUpdate
        .filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-added'))
        .attr('data-text-anchor', (_, i, n) => visaChartsUtils_umd.select(n[i]).attr('collision-text-anchor') || visaChartsUtils_umd.select(n[i]).attr('data-text-anchor'))
        .attr('collision-text-anchor', null);
      const labelsRemoved = this.seriesLabelUpdate
        .filter((_, i, n) => visaChartsUtils_umd.select(n[i]).classed('collision-removed'))
        .attr('data-use-dx', hideOnly)
        .attr('data-use-dy', hideOnly)
        .attr('keep-data-y', hideOnly)
        .attr('collision-text-anchor', (_, i, n) => visaChartsUtils_umd.select(n[i]).attr('data-text-anchor'))
  ...
  setLabelOpacity() {
    ...
    this.updatingLabels.each((d, i, n) => {
      const prevOpacity = +visaChartsUtils_umd.select(n[i]).attr('opacity');
      const styleVisibility = visaChartsUtils_umd.select(n[i]).style('visibility');
      if (!d.enter && !d.enterWholeGroup && !d.exit && !d.exitWholeGroup) {
        visaChartsUtils_umd.select(n[i]).attr('opacity', () => {
          const targetOpacity = checkInteraction(d, 1, this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
            ? 0
            : 1;
          const parentOpacity = +visaChartsUtils_umd.select(n[i].parentNode).attr('opacity');
          visaChartsUtils_umd.select(n[i]).attr('data-hidden', parentOpacity === 0 || targetOpacity === 0 ? 'true' : null);
    ...
    if (addCollisionClass) {
      ...
      if (labelsAdded.size() > 0) {
        ...
        labelsAdded.call(transitionEndAll, () => {
          this.updatingLabels.each((d, i, n) => {
            visaChartsUtils_umd.select(n[i]).classed('collision-added', false);
            // store results to hash so we can use them in lifecycle (specific to line/parallel lifecycle only)
            this.hiddenHash[`${d[this.ordinalAccessor]}-${d[this.seriesAccessor] || 'b'}`] = {
              'data-label-hidden': visaChartsUtils_umd.select(n[i]).attr('data-label-hidden') === 'true',
              x: +visaChartsUtils_umd.select(n[i]).attr('x') - +visaChartsUtils_umd.select(n[i]).attr('data-x'),
  ...
  updateDotRadius() {
    this.updateDots
      ...
      if (!d.enter && !d.enterWholeGroup && !me.classed('entering') && !d.exit) {
        me.attr('r', () => checkClicked(d, this.clickHighlight, this.innerInteractionKeys)
          ? this.dotRadius +
            (this.clickStyle && this.clickStyle.strokeWidth ? parseFloat('' + this.clickStyle.strokeWidth) / 2 : 1)
          : checkHovered(d, this.hoverHighlight, this.innerInteractionKeys)
            ? this.dotRadius +
  ...
  onHoverHandler(d, n) {
    ...
    if (this.showTooltip && d[this.ordinalAccessor]) {
      this.eventsTooltip({ data: d, evt: visaChartsUtils_umd.event, isToShow: true });
    }
  }
  ...
  bindLegendInteractivity() {
    visaChartsUtils_umd.select(this.parallelChartEl)
      .selectAll('.legend')
      .on('click', !this.suppressEvents && this.seriesInteraction && this.legend.interactive
      ? (d, i, n) => {
        if (d.values) {
          this.onClickHandler(d.values[0], n[i]);
        }
      ...
      : null)
      .on('mouseover', !this.suppressEvents && this.seriesInteraction && this.legend.interactive
      ? (d, i, n) => {
        if (d.values) {
  ...
  render() {
    ...
    // // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (index.h("div", { class: "o-layout" }, index.h("div", { class: "o-layout--chart" }, index.h(this.topLevel, { class: "parallel-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { class: "visa-ui-text--instructions parallel-sub-title vcl-sub-title" }, this.subTitle), index.h("div", { class: "parallel-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'line', chartTag: 'parallel-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), index.h("div", { class: "visa-viz-d3-parallel-container" }), index.h("div", { class: "parallel-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get parallelChartEl() { return index.getElement(this); }
  static get watchers() { return {
    ...
    "strokeWidth": ["strokeWidthWatcher"],
    "showDots": ["showDotsWatcher"],
    "dotRadius": ["dotRadiusWatcher"],
    ...
    "secondaryLines": ["secondaryLinesWatcher"],
...
ParallelPlot.style = parallelPlotCss;

exports.parallel_plot = ParallelPlot;
