import { r as registerInstance, h, g as getElement } from './index-1c5d8972.js';
import { s as select, v as visaChartsUtils_umd } from './visa-charts-utils.umd-23a648ee.js';
...
const { getLicenses: getLicenses$1 } = visaChartsUtils_umd;
const DataTable = class {
  ...
  get dataTableEl() { return getElement(this); }
};
...
const KeyboardInstructions = class {
  constructor(hostRef) {
    ...
    this.instructionsMenu = () => {
      if (this.showInstructions) {
        return (h("div", null, h("p", null, "Note: for VoiceOver users (mac), press and hold ", h("kbd", null, "Ctrl"), " + ", h("kbd", null, "Shift"), " when using the arrow keys for the best navigation experience."), h("table", { class: "vcc-ki-keyboard-instructions vcc-ki-data-table vcc-ki-state--single-select vcc-ki-state--compact", "data-header": "header" }, h("thead", { class: "vcc-ki-thead" }, h("tr", { class: "vcc-ki-tr" }, h("th", { class: "vcc-ki-th", scope: "col" }, "Action"), h("th", { class: "vcc-ki-th", scope: "col" }, "Result"))), h("tbody", { class: "vcc-ki-tbody" }, h("tr", { class: "vcc-ki-tr" }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "Enter"), " on the chart area or a ", this.groupName, "."), h("td", { class: "vcc-ki-td" }, "Enter the chart area/drill down a level.")), h("tr", { class: "vcc-ki-tr" }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "Esc"), " on a ", this.groupName, " or ", this.geomType, "."), h("td", { class: "vcc-ki-td" }, "Drill up a level.")), h("tr", { class: "vcc-ki-tr" }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "Tab"), " at any time."), h("td", { class: "vcc-ki-td" }, "Exit the chart.")), h("tr", { class: this.isInteractive ? 'vcc-ki-tr' : 'vcc-ki-tr vcc-ki-disabled-row' }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "Space"), " ", this.isInteractive ? 'on a ' + this.geomType : 'is unused', "."), h("td", { class: "vcc-ki-td" }, this.isInteractive ? 'Select/Deselect a ' + this.geomType : 'No effect on this chart', ".")), h("tr", { class: "vcc-ki-tr" }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "\u2190"), " / ", h("kbd", null, "\u2192"), " on a ", this.groupName, " or ", this.geomType, "."), h("td", { class: "vcc-ki-td" }, "Move among sibling ", this.groupName, "s or ", this.geomType, "s.")), h("tr", { class: this.hasCousinNavigation ? 'vcc-ki-tr' : 'vcc-ki-tr vcc-ki-disabled-row' }, h("th", { scope: "row", class: "vcc-ki-td" }, h("kbd", null, "\u2191"), " / ", h("kbd", null, "\u2193"), " ", this.cousinAction(), "."), h("td", { class: "vcc-ki-td" }, this.cousinResult(), "."))))));
      }
    };
  }
  ...
  get keyboardInstructionsEl() { return getElement(this); }
...
export { DataTable as data_table, KeyboardInstructions as keyboard_instructions };
