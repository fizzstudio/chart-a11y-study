...
import { l as linear, n as nest } from './linear-e4808753.js';
import { m as millisecond, s as second, a as minute, b as scaleTime } from './time-a3eb9de6.js';
...
const LineChart = class {
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'line-chart-' + v4();
  ...
  prepareScales() {
    ...
    if (this.data[0][this.ordinalAccessor] instanceof Date) {
      ...
      const timeDiffInMilliseconds = millisecond.count(minDate, maxDate);
      ...
      if (this.xAxis.unit) {
        ...
        this.x.domain([
          new Date(millisecond.offset(minDate, -genericTimePadding)),
          new Date(millisecond.offset(maxDate, genericTimePadding))
        ]);
      }
    }
    else {
  ...
  render() {
    ...
    // // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: "o-layout" }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "line-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions line-sub-title vcl-sub-title" }, this.subTitle), h("div", { class: "line-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'line', chartTag: 'line-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-line-container" }), h("div", { class: "line-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get lineChartEl() { return getElement(this); }
