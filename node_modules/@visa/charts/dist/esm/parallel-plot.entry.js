...
import { m as min } from './min-25ce8dfd.js';
import { p as point } from './band-5f1a0d38.js';
import { n as nest, l as linear } from './linear-e4808753.js';
...
import { h as hour, d as day, s as sunday, m as month, y as year } from './year-2fdc410d.js';
import { l as line } from './line-2c14dccd.js';
import { c as circleIn } from './circle-1a7bf607.js';
import './range-56de4c41.js';
import './value-3b657936.js';
import './constant-9f4692a3.js';
import './point-daba0271.js';
...
const ParallelPlot = class {
  ...
  componentWillLoad() {
    const chartID = this.uniqueID || 'parallel-plot-' + v4();
  ...
  setSeriesLabelOpacity() {
    ...
    if (addCollisionClass) {
      const labelsAdded = this.seriesLabelUpdate
        ...
        .attr('data-text-anchor', (_, i, n) => select(n[i]).attr('collision-text-anchor') || select(n[i]).attr('data-text-anchor'))
  ...
  render() {
    ...
    // // be moved into componentWillUpdate (if the stenicl bug is fixed)
    return (h("div", { class: "o-layout" }, h("div", { class: "o-layout--chart" }, h(this.topLevel, { class: "parallel-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { class: "visa-ui-text--instructions parallel-sub-title vcl-sub-title" }, this.subTitle), h("div", { class: "parallel-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { uniqueID: this.chartID, geomType: 'point', groupName: 'line', chartTag: 'parallel-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
        this.accessibility.elementsAreInterface === false &&
        this.accessibility.keyboardNavConfig &&
        this.accessibility.keyboardNavConfig.disabled }), h("div", { class: "visa-viz-d3-parallel-container" }), h("div", { class: "parallel-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { uniqueID: this.chartID, isCompact: true, tableColumns: this.tableColumns, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
  }
  init() {
    // reading properties
  ...
  get parallelChartEl() { return getElement(this); }
...
export { ParallelPlot as parallel_plot };
